        ...
        <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            <div className="p-5">
                ...
                <div className="mb-6">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                        <button
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-3 bg-blue-50 text-blue-700 font-medium rounded-xl hover:bg-blue-100 transition-colors border border-blue-200"
                        >
                        ...
                        <button
                            ...
                            className="flex items-center justify-center gap-2 px-4 py-3 bg-green-50 text-green-700 font-medium rounded-xl hover:bg-green-100 transition-colors border border-green-200"
                        >
                ...
                <div className="mb-4">
                    ...
                    <div className="w-full h-64 rounded-xl border border-gray-200 overflow-hidden bg-gray-100">
                        <MapContainer
