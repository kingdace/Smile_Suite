        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50">
            ...
            <section className="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-700 text-white overflow-hidden">
                ...
                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 lg:py-12">
                    <div className="text-center">
                        <div className="inline-flex items-center px-3 sm:px-4 py-1.5 sm:py-2 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-xs sm:text-sm font-medium mb-4 sm:mb-6">
                        ...
                        <p className="text-sm sm:text-base lg:text-lg text-blue-100 max-w-3xl mx-auto mb-6 sm:mb-8 leading-relaxed">
                        ...
                        <div className="hidden md:grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 max-w-3xl mx-auto mb-6 sm:mb-8">
                        ...
                        <div className="hidden md:flex flex-wrap justify-center items-center gap-3 sm:gap-4 lg:gap-6 text-blue-100">
                            <div className="flex items-center">
                                <CheckCircle className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-green-300" />
                                <span className="text-xs sm:text-sm">
                                    HIPAA Compliant
                                </span>
                            </div>
                            <div className="flex items-center">
                                <Award className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-yellow-300" />
                                <span className="text-xs sm:text-sm">
                                    Award Winning
                                </span>
                            </div>
                            <div className="flex items-center">
                                <TrendingUp className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2 text-blue-300" />
                                <span className="text-xs sm:text-sm">
                                    Growing Network
                                </span>
                            </div>
            ...
            <section className="relative -mt-4 sm:-mt-6 z-10">
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="bg-white/95 backdrop-blur-sm rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl border border-white/20 p-4 sm:p-6">
                        {/* Search Bar */}
                        <div className="mb-4 sm:mb-6">
                            <div className="relative max-w-2xl mx-auto">
                                <Search className="absolute left-3 sm:left-4 top-1/2 transform -translate-y-1/2 h-3 w-3 sm:h-4 sm:w-4 text-blue-500" />
                                <input
                                    type="text"
                                    className="w-full pl-8 sm:pl-10 pr-3 sm:pr-4 py-2.5 sm:py-3 border border-gray-200 rounded-lg sm:rounded-xl text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-all duration-200 bg-gray-50 focus:bg-white text-sm sm:text-base"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-4 mb-4 sm:mb-6 max-w-3xl mx-auto">
                            <div className="text-center">
                                ...
                                <select
                                    ...
                                    className="w-full px-2.5 sm:px-3 py-2 border border-gray-300 rounded-lg sm:rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white shadow-sm text-sm"
                                >
                        ...
                        <div className="flex flex-col sm:flex-row justify-between items-center gap-2 sm:gap-3">
                            <div className="flex flex-col sm:flex-row items-center gap-2 sm:gap-3">
                                <span className="inline-flex items-center px-2.5 sm:px-3 py-1 sm:py-1.5 rounded-full bg-blue-100 text-blue-800 text-xs sm:text-sm font-medium">
                                ...
                                <div className="flex items-center gap-1.5 sm:gap-2">
                                    ...
                                    <select
                                        ...
                                        className="px-2 py-1 border border-gray-300 rounded-md text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
                                    >
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {sortedClinics.length > 0 ? (
                        <div
                            className={
                                viewMode === "grid"
                                    ? "grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 sm:gap-6 lg:gap-8"
                        ...
                        >
                            {sortedClinics.map((clinic) => (
                                <div
                                    key={clinic.id}
                                    className={`group bg-white rounded-xl sm:rounded-2xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 hover:scale-[1.02] flex flex-col h-full ${
                                        viewMode === "list" ? "flex-row" : ""
                                    }`}
                                >
                                    {/* Modern Header with Enhanced Gradient Background */}
                                    <div className="relative bg-gradient-to-br from-blue-100 via-indigo-100 to-purple-100 p-4 sm:p-6 border-b border-blue-200/50">
                                        {/* Subtle Pattern Overlay */}
                                        <div className="absolute inset-0 bg-gradient-to-br from-white/20 via-transparent to-blue-200/10 rounded-t-xl sm:rounded-t-2xl"></div>
                                        {/* Decorative Elements */}
                                        <div className="absolute top-0 right-0 w-16 h-16 sm:w-24 sm:h-24 bg-gradient-to-br from-blue-400/10 to-purple-400/10 rounded-full -translate-y-8 sm:-translate-y-12 translate-x-8 sm:translate-x-12"></div>
                                        <div className="absolute bottom-0 left-0 w-12 h-12 sm:w-16 sm:h-16 bg-gradient-to-br from-indigo-400/10 to-blue-400/10 rounded-full -translate-y-6 sm:-translate-y-8 -translate-x-6 sm:-translate-x-8"></div>
                                        ...
                                        <div className="flex items-center space-x-3 sm:space-x-4">
                                            <div className="relative">
                                                ...
                                                <div className="absolute -top-0.5 -right-0.5 sm:-top-1 sm:-right-1 w-4 h-4 sm:w-6 sm:h-6 bg-green-500 rounded-full flex items-center justify-center shadow-lg">
                                                    <ShieldCheck className="w-2 h-2 sm:w-3 sm:h-3 text-white" />
                                                </div>
                                            </div>
                                            <div className="flex-1 min-w-0">
                                                <h3 className="text-base sm:text-lg font-bold text-gray-900 mb-1 line-clamp-2 leading-tight">
                                                    {clinic.name}
                                                </h3>
                                                <div className="flex items-center space-x-2 sm:space-x-3">
                                                    <div className="flex items-center bg-green-100 text-green-700 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-xs font-medium">
                                                        <ShieldCheck className="w-2.5 h-2.5 sm:w-3 sm:h-3 mr-1" />
                                                        Verified
                                                    </div>
                                                    <div className="flex items-center bg-yellow-100 text-yellow-700 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full text-xs font-medium">
                                    ...
                                    <div className="flex-1 flex flex-col p-4 sm:p-6">
                                                ...
                                                <div className="bg-gray-50 rounded-lg sm:rounded-xl p-3 sm:p-4">
                                                    ...
                                                    {clinic.description.length >
                                                        ...
                                                        <button
                                                            ...
                                                            className="text-xs sm:text-sm text-blue-600 hover:text-blue-800 font-medium mt-1.5 sm:mt-2 transition-colors flex items-center"
                                                        >
                                                            {expandedDescriptions[
                                                                clinic.id
                                                            ]
                                                                ...
                                                                : "See More"}
                                                            <ArrowRight
                                                                className={`w-2.5 h-2.5 sm:w-3 sm:h-3 ml-1 transition-transform ${
                                                                    expandedDescriptions[
                                                                        clinic
                                                                            .id
                                                                    ]
                                        ...
                                        <div className="mt-auto space-y-2 sm:space-y-3">
                                            <Link
                                                ...
                                                className="w-full inline-flex items-center justify-center px-3 sm:px-4 py-2.5 sm:py-3 bg-gradient-to-r from-blue-600 to-indigo-600 text-white font-semibold rounded-lg sm:rounded-xl hover:from-blue-700 hover:to-indigo-700 transition-all duration-200 text-xs sm:text-sm group-hover:scale-[1.02] shadow-lg"
                                            >
                                                <Eye className="w-3 h-3 sm:w-4 sm:h-4 mr-1.5 sm:mr-2" />
                                                View Details
                                            </Link>
                                            <button
                                                className="w-full inline-flex items-center justify-center px-3 sm:px-4 py-2.5 sm:py-3 bg-gradient-to-r from-emerald-600 to-teal-600 text-white font-semibold rounded-lg sm:rounded-xl hover:from-emerald-700 hover:to-teal-700 transition-all duration-200 text-xs sm:text-sm group-hover:scale-[1.02] shadow-lg"
                                                onClick={() => {
                                                    window.open(
                                                        route(
                                                            "public.clinics.profile",
                            ...
                            <div className="bg-white rounded-xl sm:rounded-2xl shadow-lg p-8 sm:p-12 max-w-md mx-auto">
                                ...
                                {(searchTerm ||
                                    ...
                                    <button
                                        ...
                                        className="inline-flex items-center px-4 sm:px-6 py-2.5 sm:py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors duration-200 text-sm"
                                    >
                                        Clear All Filters
                                    </button>
                                )}
                    ...
                    {clinics.links && clinics.links.length > 3 && (
                        <div className="mt-8 sm:mt-12 flex justify-center">
                            <nav className="bg-white rounded-lg sm:rounded-xl shadow-lg border border-gray-100 p-1.5 sm:p-2">
                                <div className="flex items-center space-x-0.5 sm:space-x-1">
                                    {clinics.links.map((link, i) => (
                                        <Link
                                            key={i}
                                            href={link.url || "#"}
                                            className={`px-2 sm:px-3 py-1.5 sm:py-2 rounded-md sm:rounded-lg text-xs sm:text-sm font-medium transition-all duration-200 ${
                                                link.active
