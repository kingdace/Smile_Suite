    ...
    return (
        <GuestLayout>
            ...
            <div className="min-h-screen bg-gradient-to-b from-blue-50 via-white to-cyan-50">
                {/* Hero Section */}
                <section className="relative bg-gradient-to-r from-cyan-500 to-blue-600 text-white">
                    <ClinicHero
                        clinic={clinic}
                ...
                {/* Services Section */}
                <section className="pt-10 pb-10 bg-gradient-to-br from-blue-50 to-cyan-50">
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                        <ServicesSection
                            clinic={clinic}
                            onBookAppointment={handleBookAppointment}
