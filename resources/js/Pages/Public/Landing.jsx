    ...
    return (
        <div
            className={`transition-all duration-200 bg-white ${
                isFirst ? "rounded-t-xl sm:rounded-t-2xl" : ""
            } ${isLast ? "rounded-b-xl sm:rounded-b-2xl" : ""} ${
                open ? "shadow-md z-10" : ""
            }`}
        >
            <button
                className={`w-full flex justify-between items-center py-3 sm:py-4 lg:py-5 px-4 sm:px-5 lg:px-6 text-left focus:outline-none transition-colors duration-150 ${
                    open ? "bg-blue-50" : "hover:bg-blue-50"
                } rounded-xl sm:rounded-2xl`}
                onClick={onClick}
                style={{ borderRadius: isFirst || isLast ? "0.75rem" : 0 }}
            >
                <span className="font-semibold text-gray-900 text-sm sm:text-base leading-tight pr-2">
                    {question}
                </span>
                <ArrowRight
                    className={`w-4 h-4 sm:w-5 sm:h-5 ml-2 flex-shrink-0 transition-transform duration-300 ${
                        open ? "rotate-90 text-blue-600" : "text-gray-400"
                    }`}
                />
            </button>
            <div
                className={`overflow-hidden transition-all duration-300 px-4 sm:px-5 lg:px-6 ${
                    open
                        ? "max-h-32 sm:max-h-40 py-2 sm:py-3 bg-blue-50"
                        : "max-h-0"
                }`}
            >
        ...
        <div className="bg-gradient-to-br from-blue-50 to-cyan-50 min-h-screen flex flex-col">
            ...
            <div className="relative overflow-hidden bg-gradient-to-br from-blue-100 via-blue-50 to-cyan-100 pb-0 z-10">
                <div className="max-w-7xl mx-auto relative z-10 flex flex-col md:flex-row items-stretch min-h-[28rem] sm:min-h-[32rem] md:min-h-[38rem] lg:min-h-[44rem]">
                    ...
                    <div className="flex flex-col md:hidden px-4 py-8">
                        {/* 1. Title */}
                        <h1
                            className="text-2xl sm:text-3xl lg:text-4xl font-extrabold tracking-tight text-gray-900 leading-tight mb-4 sm:mb-6 text-center animate-fade-in"
                        ...
                        >
                            <span className="block">
                                ...
                                <span className="bg-gradient-to-r from-blue-600 via-cyan-500 to-blue-700 bg-clip-text text-transparent relative inline-block">
                                    Dental Practice
                                    <div className="absolute left-0 bottom-0 w-full h-2 sm:h-3 bg-gradient-to-r from-blue-100 to-cyan-100 rounded-full -z-10 opacity-60"></div>
                                </span>
                            </span>
                        ...
                        {/* 2. Image */}
                        <div className="relative z-20 w-full flex justify-center mb-4 sm:mb-6">
                            <div className="relative w-full max-w-sm">
                                <img
                                    src="/images/dental-image.png"
                                    alt="Modern dental clinic management platform"
                                    className="w-full h-48 sm:h-64 object-cover rounded-xl sm:rounded-2xl shadow-lg sm:shadow-xl border-2 border-white ring-2 ring-blue-100/50"
                                    style={{
                                        boxShadow:
                                    ...
                                    loading="lazy"
                                />
                                <div className="absolute inset-0 rounded-xl sm:rounded-2xl bg-gradient-to-t from-white/60 via-blue-100/20 to-transparent pointer-events-none" />
                            </div>
                        </div>

                        {/* 3. Description */}
                        <p
                            className="text-sm sm:text-base lg:text-lg text-gray-600 max-w-2xl font-medium animate-fade-in leading-relaxed text-center mb-6 sm:mb-8"
                            style={{
                        ...
                        <div className="flex items-center justify-center gap-2 sm:gap-3 animate-fade-in">
                            <div className="flex -space-x-1 sm:-space-x-2">
                                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-blue-100 border-2 border-white flex items-center justify-center">
                                    <span className="text-blue-600 text-xs font-bold">
                                        D
                                    </span>
                                </div>
                                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-cyan-100 border-2 border-white flex items-center justify-center">
                                    <span className="text-cyan-600 text-xs font-bold">
                                        C
                                    </span>
                                </div>
                                <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-green-100 border-2 border-white flex items-center justify-center">
                                    <span className="text-blue-600 text-xs font-bold">
                                        P
                                    </span>
                                </div>
                    ...
                    <div className="hidden md:flex flex-1 flex-col justify-center px-4 sm:px-8 lg:px-16 py-4 sm:py-8 md:py-0 md:pr-0 z-10">
                        ...
                        <p
                            className="mt-2 mb-6 sm:mb-8 lg:mb-10 text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 max-w-2xl font-medium animate-fade-in leading-relaxed text-center lg:text-left"
                            style={{
                                fontFamily: "Inter, sans-serif",
                                letterSpacing: "0.01em",
                            }}
                        ...
                        <div className="mt-2 flex flex-col sm:flex-row sm:justify-start gap-3 sm:gap-4 animate-fade-in">
                            <Link
                                href={route("public.clinics.index")}
                                className="inline-flex items-center justify-center px-4 sm:px-6 lg:px-8 xl:px-10 py-2 sm:py-3 lg:py-4 border border-transparent text-sm sm:text-base lg:text-lg font-bold rounded-lg sm:rounded-xl text-white bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 hover:from-blue-700 hover:via-blue-800 hover:to-cyan-700 shadow-2xl hover:shadow-blue-500/25 transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-blue-400/50 focus:ring-offset-2 group transform hover:scale-105"
                                style={{ fontFamily: "Inter, sans-serif" }}
                            >
                                Get Started
                                <ArrowRight className="ml-2 sm:ml-3 w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 group-hover:translate-x-2 transition-transform duration-300" />
            ...
            >
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center lg:text-center mb-8 sm:mb-12 lg:mb-16 xl:mb-20">
                        <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-100/80 rounded-full border border-blue-200/50 mb-3 sm:mb-4 lg:mb-6">
                            <Zap className="w-3 h-3 sm:w-4 sm:h-4 text-blue-600" />
                            <span className="text-xs sm:text-sm text-blue-700 font-semibold tracking-wide">
                                Powerful Features
                            </span>
                        </div>
                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold tracking-tight text-gray-900 mb-3 sm:mb-4 lg:mb-6">
                            Everything you need to{" "}
                            <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                                scale your practice
                            </span>
                        </h2>
                        <p className="max-w-3xl text-sm sm:text-base lg:text-lg xl:text-xl text-gray-600 mx-auto leading-relaxed px-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col items-center text-center group animate-fade-in border border-gray-100 hover:border-blue-200 hover:scale-105 h-full">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                            ...
                            <p className="text-gray-600 text-xs sm:text-sm lg:text-base leading-relaxed flex-grow">
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col items-center text-center group animate-fade-in border border-gray-100 hover:border-cyan-200 hover:scale-105 h-full">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col items-center text-center group animate-fade-in border border-gray-100 hover:border-cyan-200 hover:scale-105 h-full">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 group-hover:scale-110 transition-transform duration-300 shadow-lg">
                                <CreditCard className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-white" />
                            </div>
                            <h3 className="text-base sm:text-lg lg:text-xl font-bold text-gray-900 mb-2 sm:mb-3 lg:mb-4">
                                Payment Processing
                            </h3>
            ...
            <section className="relative z-20 bg-gradient-to-r from-blue-600 via-blue-700 to-cyan-600 py-16 sm:py-20 px-4 sm:px-8 lg:px-16">
                <div className="max-w-4xl mx-auto text-center">
                    <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 mb-4 sm:mb-6 lg:mb-8">
                    ...
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-white mb-3 sm:mb-4 lg:mb-6">
                        Ready to find your perfect{" "}
                        <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">
                            dental clinic?
                        </span>
                    </h2>
                    <p className="text-sm sm:text-base lg:text-lg xl:text-xl text-blue-100 mb-6 sm:mb-8 lg:mb-10 max-w-3xl mx-auto leading-relaxed px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                        ...
                        <Link
                            href="#testimonials"
                            className="inline-flex items-center justify-center px-4 sm:px-6 lg:px-8 xl:px-10 py-2 sm:py-3 lg:py-4 border-2 border-white/30 text-sm sm:text-base lg:text-lg font-bold rounded-lg sm:rounded-xl text-white bg-transparent hover:bg-white/10 hover:border-white/50 shadow-lg hover:shadow-xl transition-all duration-300 focus:outline-none focus:ring-4 focus:ring-white/30 focus:ring-offset-2 group transform hover:scale-105"
                            style={{ fontFamily: "Inter, sans-serif" }}
                        >
                            Read Reviews
                            <Star className="ml-2 w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 group-hover:scale-110 transition-transform duration-300" />
                        </Link>
                    </div>
                </div>
            </section>
            ...
            <section className="py-16 sm:py-20 lg:py-24 bg-gradient-to-b from-white to-gray-50 border-t border-b border-gray-100 z-10 relative">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="text-center mb-8 sm:mb-12 lg:mb-16">
                        ...
                        <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-extrabold text-gray-900 mb-3 sm:mb-4 lg:mb-6">
                            Everything you need to{" "}
                            <span className="bg-gradient-to-r from-blue-600 to-cyan-600 bg-clip-text text-transparent">
                                know
                            </span>
                    ...
                    <div className="rounded-lg sm:rounded-xl lg:rounded-2xl bg-white/80 shadow-lg sm:shadow-xl divide-y divide-gray-200 p-1 sm:p-2">
                        {faqs.map((faq, i) => (
                            <FaqItem
                                key={i}
                                question={faq.q}
            ...
            >
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col items-center text-center animate-fade-in border border-gray-100 hover:border-blue-200 hover:scale-105">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-pink-500 to-pink-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 shadow-lg">
                                <Avatar name="Dr. Alice Smith" />
                            </div>
                            <div className="flex items-center gap-1 text-yellow-400 mb-2 sm:mb-3 lg:mb-4">
                                <Star className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 fill-yellow-400" />
                                <Star className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 fill-yellow-400" />
                                <Star className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 fill-yellow-400" />
                                <Star className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 fill-yellow-400" />
                                <Star className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 fill-yellow-400" />
                            </div>
                            <p className="text-gray-700 mb-3 sm:mb-4 lg:mb-6 text-xs sm:text-sm lg:text-lg leading-relaxed italic">
                            ...
                            <div className="text-center">
                                <div className="text-blue-700 font-bold text-sm sm:text-base lg:text-lg">
                                    Dr. Alice Smith
                                </div>
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col items-center text-center animate-fade-in border border-gray-100 hover:border-cyan-200 hover:scale-105">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 shadow-lg">
                            ...
                            <div className="text-center">
                                <div className="text-cyan-700 font-bold text-sm sm:text-base lg:text-lg">
                                    Dr. Michael Chen
                                </div>
                                <div className="text-gray-500 text-xs sm:text-sm">
                                    Orthodontist
                        ...
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col items-center text-center animate-fade-in border border-gray-100 hover:border-orange-200 hover:scale-105">
                            <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-orange-500 to-orange-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 shadow-lg">
                            ...
                            <div className="text-center">
                                <div className="text-orange-700 font-bold text-sm sm:text-base lg:text-lg">
                                    Sarah Johnson
                                </div>
                                <div className="text-gray-500 text-xs sm:text-sm">
                                    Practice Manager
            ...
            >
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
                        {/* Basic Plan */}
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col animate-fade-in border border-gray-200 hover:border-blue-200 hover:scale-105">
                            <div className="text-center mb-4 sm:mb-6">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-blue-500 to-blue-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 shadow-lg mx-auto">
                                    <Users className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-white" />
                                </div>
                            ...
                            <div className="flex-1">
                                <ul className="text-gray-600 mb-4 sm:mb-6 lg:mb-8 space-y-1 sm:space-y-2 lg:space-y-3 text-left w-full text-xs sm:text-sm lg:text-base">
                            ...
                            <div className="mt-auto">
                                <Link href={route("register.clinic")}>
                                    <button className="w-full px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-lg sm:rounded-xl bg-blue-600 text-white font-bold hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 shadow-lg text-xs sm:text-sm lg:text-base">
                                        Start Free Trial
                                    </button>
                                </Link>
                            </div>
                        ...
                        {/* Premium Plan */}
                        <div className="bg-gradient-to-br from-blue-600 to-blue-700 rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-2xl p-4 sm:p-6 lg:p-8 flex flex-col scale-105 animate-fade-in relative border-2 sm:border-4 border-blue-500">
                            <div className="absolute -top-3 sm:-top-4 left-1/2 transform -translate-x-1/2">
                                <span className="bg-yellow-400 text-yellow-900 px-3 sm:px-4 py-1 rounded-full text-xs sm:text-sm font-bold">
                                    MOST POPULAR
                                </span>
                            </div>
                            <div className="text-center mb-4 sm:mb-6">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-white/20 backdrop-blur-sm rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 shadow-lg mx-auto">
                                    <ShieldCheck className="w-5 h-5 sm:w-6 sm:h-6 lg:w-8 lg:h-8 text-white" />
                                </div>
                                ...
                                <p className="text-2xl sm:text-3xl lg:text-4xl font-extrabold text-white mb-2">
                                    ₱1,999{" "}
                                    <span className="text-sm sm:text-base lg:text-lg font-medium text-blue-100">
                                        /mo
                                    </span>
                                </p>
                                <p className="text-blue-100 mb-3 sm:mb-4 lg:mb-6 text-xs sm:text-sm lg:text-base">
                                    For growing practices
                                </p>
                            </div>

                            <div className="flex-1">
                                <ul className="text-blue-100 mb-4 sm:mb-6 lg:mb-8 space-y-1 sm:space-y-2 lg:space-y-3 text-left w-full text-xs sm:text-sm lg:text-base">
                                    <li className="flex items-center gap-2 sm:gap-3">
                                        <CheckCircle className="w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 text-green-300 flex-shrink-0" />
                                        <span className="leading-tight">
                                            Everything in Basic
                                        </span>
                                    </li>
                            ...
                            <div className="mt-auto">
                                <Link href={route("register.clinic")}>
                                    <button className="w-full px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-lg sm:rounded-xl bg-white text-blue-700 font-bold hover:bg-blue-50 transition-all duration-300 transform hover:scale-105 shadow-lg text-xs sm:text-sm lg:text-base">
                                        Get Started
                                    </button>
                                </Link>
                            </div>
                        ...
                        {/* Enterprise Plan */}
                        <div className="bg-white rounded-xl sm:rounded-2xl lg:rounded-3xl shadow-lg hover:shadow-2xl transition-all duration-300 p-4 sm:p-6 lg:p-8 flex flex-col animate-fade-in border border-gray-200 hover:border-cyan-200 hover:scale-105">
                            <div className="text-center mb-4 sm:mb-6">
                                <div className="w-10 h-10 sm:w-12 sm:h-12 lg:w-16 lg:h-16 bg-gradient-to-br from-cyan-500 to-cyan-600 rounded-lg sm:rounded-xl lg:rounded-2xl flex items-center justify-center mb-3 sm:mb-4 lg:mb-6 shadow-lg mx-auto">
                            ...
                            <div className="mt-auto">
                                <Link href={route("register.clinic")}>
                                    <button className="w-full px-4 sm:px-6 lg:px-8 py-2 sm:py-3 lg:py-4 rounded-lg sm:rounded-xl bg-cyan-600 text-white font-bold hover:bg-cyan-700 transition-all duration-300 transform hover:scale-105 shadow-lg text-xs sm:text-sm lg:text-base">
                                        Get Started
                                    </button>
                                </Link>
                            </div>
            ...
            >
                ...
                <div className="max-w-4xl mx-auto text-center py-12 sm:py-16 md:py-20 lg:py-24 xl:py-32 px-4 sm:px-6 lg:px-8 relative z-10">
                    <div className="inline-flex items-center gap-2 px-3 sm:px-4 py-1.5 sm:py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30 mb-4 sm:mb-6 lg:mb-8">
                    ...
                    <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-6xl font-extrabold text-white mb-3 sm:mb-4 lg:mb-6">
                        Ready to transform your{" "}
                        <span className="bg-gradient-to-r from-yellow-300 to-orange-300 bg-clip-text text-transparent">
                            dental practice?
                        </span>
                    </h2>
                    <p className="mb-6 sm:mb-8 lg:mb-12 text-sm sm:text-base lg:text-lg xl:text-xl leading-5 sm:leading-6 lg:leading-7 xl:leading-8 text-blue-100 max-w-3xl mx-auto px-4">
                    ...
                    <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
                        ...
                        >
                            Browse Clinics
                            <Globe className="ml-2 w-3 h-3 sm:w-4 sm:h-4 lg:w-5 lg:h-5 group-hover:scale-110 transition-transform duration-300" />
                        </Link>
                    </div>
