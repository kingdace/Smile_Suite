            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50">
                                ...
                                <div className="flex items-center justify-between">
                                    ...
                                    <div className="flex items-center space-x-3">
                                        <TimeRangeSelector
                                            ...
                                            availableRanges={available_time_ranges}
                                            loading={loading}
                                        />
                                        <DashboardCustomizer
                                        ...
                                        <Button
                                            size="sm"
                                            asChild
                                            className="hidden sm:flex bg-white/20 text-white border-white/40 hover:bg-white/30 backdrop-blur-sm rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105"
                                        >
                                            <Link href={route("clinic.reports.index", { clinic: clinic.id })}>
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-6 pb-8 -mt-1">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        <Card className="border-t-1 shadow-lg bg-gradient-to-br from-blue-50 to-indigo-100 hover:shadow-xl transition-all duration-300 group">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-blue-700 mb-1">Today's Appointments</p>
                                        <p className="text-3xl font-bold text-blue-900">{today_appointments?.length || 0}</p>
                        ...
                        <Card className="border-t-1 shadow-lg bg-gradient-to-br from-emerald-50 to-green-100 hover:shadow-xl transition-all duration-300 group">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-emerald-700 mb-1">Total Patients</p>
                                        <p className="text-3xl font-bold text-emerald-900">{stats?.total_patients || 0}</p>
                                        <div className="flex items-center mt-2">
                                            <TrendingUp className="h-4 w-4 text-emerald-500 mr-1" />
                        ...
                        <Card className="border-t-1 shadow-lg bg-gradient-to-br from-indigo-50 to-blue-100 hover:shadow-xl transition-all duration-300 group">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-indigo-700 mb-1">Revenue ({timeRange})</p>
                                        <p className="text-3xl font-bold text-indigo-900">
                                            ₱{revenue_metrics?.current_revenue ? Number(revenue_metrics.current_revenue).toLocaleString() : '0'}
                                        </p>
                                        <div className="flex items-center mt-2">
                                            {revenue_metrics?.trend_direction === 'up' ? (
                                                <TrendingUp className="h-4 w-4 text-emerald-500 mr-1" />
                                            ) : (
                                                <TrendingDown className="h-4 w-4 text-red-500 mr-1" />
                                            )}
                                            <span className={`text-sm font-medium ${revenue_metrics?.trend_direction === 'up' ? 'text-emerald-600' : 'text-red-600'}`}>
                                                {revenue_metrics?.trend_percentage ? `${Math.abs(revenue_metrics.trend_percentage)}%` : '0%'}
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <Card className="border-t-1 shadow-lg bg-gradient-to-br from-teal-50 to-cyan-100 hover:shadow-xl transition-all duration-300 group">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                                        <p className="text-sm font-medium text-teal-700 mb-1">Satisfaction</p>
                                        <div className="flex items-baseline">
                                            <p className="text-3xl font-bold text-teal-900">
                                                {satisfaction_metrics?.average_rating ? Number(satisfaction_metrics.average_rating).toFixed(1) : '0.0'}
                                            </p>
                                            <span className="text-lg text-teal-600 ml-1">/5</span>
                                        </div>
                                        <div className="flex items-center mt-2">
                                            <Star className="h-4 w-4 text-teal-500 mr-1" />
                                            <span className="text-sm text-teal-600 font-medium">
                                                {satisfaction_metrics?.total_reviews || 0} reviews
                                            </span>
                                        </div>
                                    </div>
                                ...
                                <CardHeader className="pb-4 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-t-lg">
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <div>
                                                <CardTitle className="text-2xl font-bold text-white">Appointment Schedule</CardTitle>
                                                <p className="text-blue-100 font-medium">Today & Upcoming appointments</p>
                                            </div>
                                        </div>
                                        <div className="flex items-center space-x-2">
                                            <Button variant="outline" size="sm" asChild className="border-white/50 text-white hover:bg-white/30 backdrop-blur-sm bg-white/10">
                                                <Link href={route("clinic.appointments.calendar", { clinic: clinic.id })}>
                                                    <CalendarClock className="h-4 w-4 mr-2" />
                                                    Calendar View
                                                </Link>
                                            </Button>
                                            <Button variant="outline" size="sm" asChild className="border-white/50 text-white hover:bg-white/30 backdrop-blur-sm bg-white/10">
                                                <Link href={route("clinic.appointments.index", { clinic: clinic.id })}>
                                                    View All
                                ...
                                <CardContent className="p-6">
                                    ...
                                    <div className="mb-6 flex-1">
                                        <div className="flex items-center space-x-2 mb-3">
                                            ...
                                            <h3 className="text-base font-semibold text-blue-900">Today - {format(new Date(), "MMM d, yyyy")}</h3>
                                            <Badge className="bg-blue-100 text-blue-700 text-xs px-2 py-1">
                                                {today_appointments?.length || 0} appointments
                                            </Badge>
                                        </div>
                                        
                                        {today_appointments && today_appointments.length > 0 ? (
                                            <div className="space-y-2 min-h-[200px]">
                                                {today_appointments.slice(0, 5).map((appointment, index) => (
                                                    <div
                                                        key={appointment.id}
                                                    ...
                                                    >
                                                        <div className="flex items-center space-x-3">
                                                            <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-full flex items-center justify-center text-white font-semibold text-xs shadow-sm">
                                                                {(appointment.patient?.first_name || appointment.patient?.name || "P").charAt(0).toUpperCase()}
                                                            </div>
                                                            <div>
                                                                ...
                                                                <div className="flex items-center space-x-2 text-xs text-blue-600">
                                                                        ...
                                                                        {(() => {
                                                                            try {
                                                                                if (appointment.scheduled_at) {
                                                                                    return format(new Date(appointment.scheduled_at), "h:mm a");
                                                                                }
                                                                                return "Time not set";
                                                                            } catch {
                                                                                return "Time not set";
                                                                    ...
                                                                    <span>•</span>
                                                                    <span>{appointment.appointment_type?.name || "General"}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <Badge className={`${getStatusColor(appointment.appointment_status_id)} text-xs px-2 py-1 shadow-sm`}>
                                                            {getStatusText(appointment.appointment_status_id)}
                                                        </Badge>
                                                    </div>
                                                ))}
                                            </div>
                                            ...
                                            <div className="text-center py-12 bg-blue-50 rounded-lg border border-blue-200 min-h-[200px] flex flex-col justify-center">
                                                ...
                                                <p className="text-blue-600 font-medium text-sm">No appointments today</p>
                                                <p className="text-blue-500 text-xs mt-1">Your schedule is clear!</p>
                                            </div>
                                        )}
                                    </div>
                                    ...
                                    {upcoming_appointments && upcoming_appointments.length > 0 && (
                                        <div className="flex-shrink-0">
                                            <div className="flex items-center space-x-2 mb-2">
                                                ...
                                                <h3 className="text-sm font-medium text-emerald-900">Upcoming Appointments</h3>
                                                <Badge className="bg-emerald-100 text-emerald-700 text-xs px-2 py-1">
                                                    Next {upcoming_appointments.slice(0, 3).length}
                                                </Badge>
                                            </div>
                                            
                                            <div className="space-y-1">
                                                {upcoming_appointments.slice(0, 3).map((appointment, index) => (
                                                    <div
                                                        key={appointment.id}
                                                                ...
                                                                <div className="flex items-center space-x-2 text-xs text-emerald-600">
                                                                    ...
                                                                    <span>
                                                                        {(() => {
                                                                            try {
                                                                                if (appointment.scheduled_at) {
                                                                                    return format(new Date(appointment.scheduled_at), "MMM d, h:mm a");
                                                                                }
                                                                                return "Date not set";
                                                                            } catch {
                                                                                return "Date not set";
                                ...
                                <CardHeader className="pb-4 bg-gradient-to-r from-cyan-600 to-teal-600 text-white rounded-t-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            ...
                                            <p className="text-cyan-100 font-medium">Common tasks & shortcuts</p>
                                        </div>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6 space-y-4">
                                    <Button asChild className="w-full justify-start h-16 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
                                        <Link href={route("clinic.patients.create", { clinic: clinic.id })}>
                                            <UserCheck className="h-6 w-6 mr-4" />
                                            <div className="text-left">
                                                <div className="font-bold text-base">Add Patient</div>
                                                <div className="text-sm opacity-90">Register new patient</div>
                                            </div>
                                        </Link>
                                    </Button>
                                    
                                    <Button asChild className="w-full justify-start h-16 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
                                        <Link href={route("clinic.appointments.create-simplified", { clinic: clinic.id })}>
                                            <Calendar className="h-6 w-6 mr-4" />
                                            <div className="text-left">
                                                <div className="font-bold text-base">Book Appointment</div>
                                                <div className="text-sm opacity-90">Schedule new visit</div>
                                            </div>
                                        </Link>
                                    </Button>
                                    
                                    <Button asChild className="w-full justify-start h-16 bg-gradient-to-r from-indigo-500 to-blue-600 hover:from-indigo-600 hover:to-blue-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
                                        <Link href={route("clinic.treatments.create", { clinic: clinic.id })}>
                                            <Stethoscope className="h-6 w-6 mr-4" />
                                            <div className="text-left">
                                                <div className="font-bold text-base">Record Treatment</div>
                                                <div className="text-sm opacity-90">Log treatment details</div>
                                            </div>
                                        </Link>
                                    </Button>
                                    
                                    <Button asChild className="w-full justify-start h-16 bg-gradient-to-r from-cyan-500 to-teal-600 hover:from-cyan-600 hover:to-teal-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
                                        <Link href={route("clinic.payments.create", { clinic: clinic.id })}>
                                            <DollarSign className="h-6 w-6 mr-4" />
                                            <div className="text-left">
                                                <div className="font-bold text-base">Process Payment</div>
                                                <div className="text-sm opacity-90">Record transaction</div>
                                            </div>
                                        </Link>
                                    </Button>

                                    <Button asChild className="w-full justify-start h-16 bg-gradient-to-r from-teal-500 to-cyan-600 hover:from-teal-600 hover:to-cyan-700 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1 hover:scale-105">
                                        <Link href={route("clinic.dentist-schedules.index", { clinic: clinic.id })}>
                                            <Clock className="h-6 w-6 mr-4" />
                                            <div className="text-left">
                                                <div className="font-bold text-base">Manage Schedules</div>
                                                <div className="text-sm opacity-90">Dentist availability</div>
                                            </div>
                                        </Link>
                                    </Button>
                                </CardContent>
                                    ...
                                    <CardHeader className="pb-4">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                ...
                                                <p className="text-sm text-slate-500">Revenue over time ({timeRange})</p>
                                            </div>
                                    ...
                                    <CardContent>
                                        <div className="h-64">
                                            <ResponsiveContainer width="100%" height="100%">
                                                <AreaChart data={chart_data.revenue_chart}>
                                                    <defs>
                            ...
                            {chart_data?.appointment_chart && (
                                <Card className="border-0 shadow-lg bg-white">
                                    <CardHeader className="pb-4">
                                        <div className="flex items-center justify-between">
                                            <div>
                                                <CardTitle className="text-lg font-semibold text-slate-900">Appointment Volume</CardTitle>
                                                <p className="text-sm text-slate-500">Appointments over time ({timeRange})</p>
                                            </div>
                                    ...
                                    <CardContent>
                                        <div className="h-64">
                                            <ResponsiveContainer width="100%" height="100%">
                                                <BarChart data={chart_data.appointment_chart}>
                                                    <CartesianGrid strokeDasharray="3 3" stroke="#e2e8f0" />
                                                    <XAxis dataKey="date" stroke="#64748b" fontSize={12} />
                                                    <YAxis stroke="#64748b" fontSize={12} />
                                                    <Tooltip 
                                                    ...
                                                    />
                                                    <Bar dataKey="count" fill={brandColors.primary} radius={[4, 4, 0, 0]} />
                                                </BarChart>
                                            </ResponsiveContainer>
                                        </div>
                                    </CardContent>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                            ...
                            <CardHeader className="pb-4 bg-gradient-to-r from-emerald-600 to-green-600 text-white rounded-t-lg">
                                <div className="flex items-center justify-between">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <CardTitle className="text-xl font-semibold text-white">Recent Patients</CardTitle>
                                            <p className="text-emerald-100 font-normal">Latest registrations</p>
                                        </div>
                                    </div>
                                    <Button variant="outline" size="sm" asChild className="border-white/50 text-white hover:bg-white/30 backdrop-blur-sm bg-white/10">
                                                
                                        <Link href={route("clinic.patients.index", { clinic: clinic.id })}>
                                            View All
                                            <ChevronRight className="h-4 w-4 ml-1" />
                                        </Link>
                                    </Button>
                            ...
                            <CardContent className="p-6">
                                {recent_patients && recent_patients.length > 0 ? (
                                    <div className="space-y-4">
                                        {recent_patients.slice(0, 4).map((patient) => (
                                            <div key={patient.id} className="flex items-center space-x-4 p-4 bg-gradient-to-r from-emerald-50 to-green-50 rounded-xl hover:from-emerald-100 hover:to-green-100 transition-all duration-300 border border-emerald-200 hover:border-emerald-300 shadow-sm hover:shadow-md transform hover:-translate-y-1">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-xs text-emerald-600 font-normal">
                                                        {(() => {
                                                            try {
                                                                return patient.created_at ? format(new Date(patient.created_at), "MMM d, yyyy") : "Recently";
                                                            } catch {
                                                                return "Recently";
                                                            }
                                                        })()}
                                    ...
                                    <div className="text-center py-12 bg-gradient-to-br from-emerald-50 to-green-100 rounded-xl border-2 border-dashed border-emerald-300">
                                        ...
                                        <p className="text-emerald-700 font-medium text-base">No recent patients</p>
                                        <p className="text-emerald-600 text-sm mt-2">New registrations will appear here</p>
                                        <Button asChild className="mt-4 bg-gradient-to-r from-emerald-500 to-green-600 hover:from-emerald-600 hover:to-green-700 text-white shadow-lg">
                                            <Link href={route("clinic.patients.create", { clinic: clinic.id })}>
                        ...
                        {(lowStockItems?.length > 0 || patientCancelledAppointments?.length > 0) ? (
                            <Card className="border-0 shadow-xl bg-gradient-to-br from-white via-amber-50 to-orange-50 hover:shadow-2xl transition-all duration-300">
                                <CardHeader className="pb-4 bg-gradient-to-r from-amber-600 to-orange-600 text-white rounded-t-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <CardTitle className="text-xl font-semibold text-white">Alerts & Notifications</CardTitle>
                                            <p className="text-amber-100 font-normal">Items requiring attention</p>
                                        </div>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6 space-y-4">
                                    ...
                                    {lowStockItems?.slice(0, 3).map((item) => (
                                        <div key={item.id} className="flex items-center justify-between p-4 bg-gradient-to-r from-amber-50 to-orange-50 rounded-xl border border-amber-200 hover:border-amber-300 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-1">
                                            <div className="flex items-center space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-amber-700 font-normal">Stock: {item.quantity} {item.unit}</p>
                                                </div>
                                            </div>
                                    ...
                                    {/* Patient Changes */}
                                    {patientCancelledAppointments?.slice(0, 2).map((appointment) => (
                                        <div key={`cancelled-${appointment.id}`} className="flex items-center justify-between p-4 bg-gradient-to-r from-red-50 to-pink-50 rounded-xl border border-red-200 hover:border-red-300 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-1">
                                            <div className="flex items-center space-x-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-xs text-red-700 font-normal">Cancelled appointment</p>
                                                </div>
                                            </div>
                            ...
                            <Card className="border-0 shadow-xl bg-gradient-to-br from-white via-green-50 to-emerald-50 hover:shadow-2xl transition-all duration-300">
                                <CardHeader className="pb-4 bg-gradient-to-r from-green-600 to-emerald-600 text-white rounded-t-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <CardTitle className="text-2xl font-bold text-white">All Clear!</CardTitle>
                                            <p className="text-green-100 font-medium">No alerts at this time</p>
                                        </div>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6">
                                    <div className="text-center py-12 bg-gradient-to-br from-green-50 to-emerald-100 rounded-xl border-2 border-dashed border-green-300">
                                        ...
                                        <p className="text-green-700 font-bold text-lg">Everything looks great!</p>
                                        <p className="text-green-600 text-sm mt-2">No urgent items need your attention</p>
                                    </div>
                                </CardContent>
                            </Card>
                        )}
                    ...
                    {chart_data?.service_distribution && chart_data.service_distribution.length > 0 && (
                        <div className="mb-8">
                            <Card className="border-0 shadow-xl bg-gradient-to-br from-white via-indigo-50 to-blue-50 hover:shadow-2xl transition-all duration-300">
                                <CardHeader className="pb-4 bg-gradient-to-r from-indigo-600 to-blue-600 text-white rounded-t-lg">
                                    <div className="flex items-center space-x-3">
                                        ...
                                        <div>
                                            <CardTitle className="text-xl font-semibold text-white">Service Distribution</CardTitle>
                                            <p className="text-indigo-100 font-normal">Popular services ({timeRange})</p>
                                        </div>
                                    </div>
                                </CardHeader>
                                <CardContent className="p-6">
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                        <div className="h-64">
                                            <ResponsiveContainer width="100%" height="100%">
                                                <PieChart>
                                                    <Pie
                                                        data={chart_data.service_distribution}
                                                        cx="50%"
                                                        cy="50%"
                                                        innerRadius={50}
                                                        outerRadius={100}
                                                        ...
                                                        dataKey="value"
                                                    >
                                                        {chart_data.service_distribution.map((entry, index) => {
                                                            const colors = [brandColors.primary, brandColors.secondary, brandColors.info, brandColors.teal, brandColors.indigo];
                                                            return (
                                        ...
                                        <div className="space-y-4">
                                            {chart_data.service_distribution.slice(0, 5).map((service, index) => {
                                                const colors = [brandColors.primary, brandColors.secondary, brandColors.info, brandColors.teal, brandColors.indigo];
                                                return (
                                                    <div key={service.name} className="flex items-center justify-between p-4 bg-gradient-to-r from-indigo-50 to-blue-50 rounded-xl border border-indigo-200 hover:border-indigo-300 transition-all duration-300 shadow-sm hover:shadow-md transform hover:-translate-y-1">
                                                        <div className="flex items-center space-x-4">
                                                            <div 
                                                                className="w-6 h-6 rounded-full shadow-lg border-2 border-white" 
                                                                style={{ backgroundColor: colors[index % colors.length] }}
                                                            />
                                                            <span className="text-sm text-indigo-900 font-medium">{service.name}</span>
                                                        </div>
