...
export default function Show({ auth, clinic, inventory, transactions = [] }) {
    ...
    const getExpiryStatus = () => {
        if (!inventory.expiry_date)
            return { label: "No Expiry", color: "default", icon: Timer };
    ...
    const handleQuantityAdjustment = (e) => {
        ...
        post(
            route("clinic.inventory.adjust-quantity", [
                clinic.id,
                inventory.id,
            ]),
            {
            ...
            <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-cyan-50">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                        ...
                        {/* Total Value */}
                        <Card className="border-0 shadow-xl bg-gradient-to-br from-blue-50 to-indigo-100 hover:shadow-2xl transition-all duration-300 group">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                        ...
                        <Card className="border-0 shadow-xl bg-gradient-to-br from-purple-50 to-violet-100 hover:shadow-2xl transition-all duration-300 group">
                            <CardContent className="p-6">
                                <div className="flex items-center justify-between">
                                    <div>
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                        ...
                        <Card className="border-0 shadow-xl bg-white/95 backdrop-blur-sm">
                            <CardHeader className="pb-4 bg-gradient-to-r from-blue-50/50 to-indigo-50/50 border-b border-gray-100">
                                <div className="flex items-center space-x-3">
                        ...
                        {/* Pricing Information */}
                        <Card className="border-0 shadow-xl bg-white/95 backdrop-blur-sm">
                            <CardHeader className="pb-4 bg-gradient-to-r from-emerald-50/50 to-green-50/50 border-b border-gray-100">
                                <div className="flex items-center space-x-3">
                        ...
                        <Card className="border-0 shadow-xl bg-white/95 backdrop-blur-sm">
                            <CardHeader className="pb-4 bg-gradient-to-r from-purple-50/50 to-violet-50/50 border-b border-gray-100">
                                <div className="flex items-center space-x-3">
                    ...
                    >
                        <DialogContent className="sm:max-w-md">
                            <DialogHeader>
                                ...
                                <DialogDescription>
                                    Current stock:{" "}
                                    <strong>{inventory.quantity}</strong> units
                                </DialogDescription>
                            </DialogHeader>
                            <form
