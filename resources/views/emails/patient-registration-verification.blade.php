...
<head>
    ...
    <title>Verify Your Email - Smile Suite Registration</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="content">
            ...
            <p>Thank you for registering with Smile Suite! To complete your registration and activate your patient account, please use the verification code below:</p>
            ...
            <ul style="margin: 10px 0; padding-left: 20px;">
                ...
                <li>Book appointments with dental clinics</li>
                <li>View your dental records</li>
        ...
        <div class="footer">
            ...
            <p>This email was sent to verify your Smile Suite registration.</p>
        </div>
    </div>
</body>
</html>
