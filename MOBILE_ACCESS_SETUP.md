...
php artisan serve --host=192.168.1.25 --port=8000
...
-   **Network (Mobile/Other Devices)**:
    -   Laravel: `http://192.168.1.25:8000`
    -   Vite Dev: `http://192.168.1.25:5173`
...
'allowed_origins' => [
    ...
    'http://192.168.1.25:5173',    // âœ… Added
    'http://192.168.1.25:8000'     // âœ… Added
],
```
...
```javascript
server: {
    host: "192.168.1.25",           // âœ… Already configured
    port: 5173,
    hmr: {
        host: "192.168.1.25", // âœ… Updated for network
    },
},
```
...
```json
"scripts": {
    "serve:network": "php artisan serve --host=192.168.1.25 --port=8000",
    "dev:network": "vite --host 192.168.1.25"
}
```
...
-   Open browser and navigate to: `http://192.168.1.25:8000`
-   The app should load and be fully functional

### **Step 4: Test Vite Dev Server**

-   On mobile: `http://192.168.1.25:5173`
...
1. **Check Server Status**
    ...
    ```bash
    # Verify Laravel is running on 192.168.1.25
...
âœ… **Laravel server shows**: `Server running on [http://192.168.1.25:8000]`  
âœ… **Vite shows**: `Local: http://localhost:5173/` and `Network: http://192.168.1.25:5173/`  
âœ… **Mobile device can access**: `http://192.168.1.25:8000`  
