import{j as t,$ as f,m as u}from"./app-DTy0tD3l.js";import{B as s}from"./button-BJRVm_8x.js";import{A as j}from"./arrow-left-C1T4O9Ty.js";import{D as w}from"./download-CU4DPfQa.js";import{P as N}from"./printer-DLeyd3ZC.js";import{S as v,P as k}from"./scissors-CXDFl25y.js";import{S as P}from"./stethoscope-Dxw25VHv.js";import{D}from"./dollar-sign-BxIfWi9m.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Bf28fp4_.js";import"./createLucideIcon-BD5HiQDM.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
