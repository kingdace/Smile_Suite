import{j as t,$ as f,m as u}from"./app-CF_RM_5K.js";import{B as s}from"./button-honWSdnj.js";import{A as j}from"./arrow-left-CQbrXm5t.js";import{D as w}from"./download-CwK_WRJF.js";import{P as N}from"./printer-DwXWUcGw.js";import{S as v,P as k}from"./scissors-ChkEKGEY.js";import{S as P}from"./stethoscope-D_hzwDXA.js";import{D}from"./dollar-sign-CGKzjhLo.js";import{f as d}from"./format-CYZdy3_o.js";import"./index--bjt601N.js";import"./createLucideIcon-BYKm02iR.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
