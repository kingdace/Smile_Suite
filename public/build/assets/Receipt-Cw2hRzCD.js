import{j as t,$ as f,m as u}from"./app-0AK_PysF.js";import{B as s}from"./button-UWb-112-.js";import{A as j}from"./arrow-left-D866Dats.js";import{D as w}from"./download-2MgdbaMw.js";import{P as N}from"./printer-jU1jplPh.js";import{S as v,P as k}from"./scissors-DCBfkbHd.js";import{S as P}from"./stethoscope-BfohszP3.js";import{D}from"./dollar-sign-DS4Q6CYd.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-C5r27CPj.js";import"./createLucideIcon-BtjveBY1.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
