import{j as t,$ as f,m as u}from"./app-CR7X77Ta.js";import{B as s}from"./button-ulXQEehi.js";import{A as j}from"./arrow-left-CQsH__ts.js";import{D as w}from"./download-Czo9QeO7.js";import{P as N}from"./printer-DLKmktHQ.js";import{S as v,P as k}from"./scissors-BJ-D89op.js";import{S as P}from"./stethoscope-B9oiDCYU.js";import{D}from"./dollar-sign-CHt5BCTz.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DyaY0mbY.js";import"./createLucideIcon-hN-0My15.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
