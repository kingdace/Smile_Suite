import{j as t,$ as f,m as u}from"./app-BcPHU64q.js";import{B as s}from"./button-ChC5MGx7.js";import{A as j}from"./arrow-left-rCJWFrgE.js";import{D as w}from"./download-VoDe8bq4.js";import{P as N}from"./printer-CFEYfMPT.js";import{S as v,P as k}from"./scissors-iiSZv2q_.js";import{S as P}from"./stethoscope-CHPaQfqO.js";import{D}from"./dollar-sign-DPhHGD4o.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Bbyp2hmO.js";import"./createLucideIcon-DJkwDLdQ.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
