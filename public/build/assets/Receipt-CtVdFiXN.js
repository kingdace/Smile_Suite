import{j as t,$ as f,m as u}from"./app-ChLTtnho.js";import{B as s}from"./button-Dkwd29Mf.js";import{A as j}from"./arrow-left-AEZrpUQS.js";import{D as w}from"./download-kmAUpFUj.js";import{P as N}from"./printer-0TRms1E6.js";import{S as v,P as k}from"./scissors-CxdNsG7j.js";import{S as P}from"./stethoscope-kLpiwG9B.js";import{D}from"./dollar-sign-Tt91oIDU.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DPcDqeCx.js";import"./createLucideIcon-Cgi_UPtC.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
