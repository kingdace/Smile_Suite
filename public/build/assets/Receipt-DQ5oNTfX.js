import{j as t,$ as f,m as u}from"./app-BXbSklUb.js";import{B as s}from"./button-8NIX7dhj.js";import{A as j}from"./arrow-left-D77YEe0r.js";import{D as w}from"./download-8eymWiTv.js";import{P as N}from"./printer-DgdmQBW3.js";import{S as v,P as k}from"./scissors-O3ezu4Ij.js";import{S as P}from"./stethoscope-DTEocxfb.js";import{D}from"./dollar-sign-Cvtr_vL9.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-bNWGn6T6.js";import"./createLucideIcon-93y5-7Ib.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
