import{j as t,$ as f,m as u}from"./app-RZgRBzca.js";import{B as s}from"./button-Cj3C9UYJ.js";import{A as j}from"./arrow-left-C0W9Em1o.js";import{D as w}from"./download-BCmQZxAr.js";import{P as N}from"./printer-BDlN83LX.js";import{S as v,P as k}from"./scissors-Bkdt_pzN.js";import{S as P}from"./stethoscope-BFct64Zi.js";import{D}from"./dollar-sign-8IYD-E-I.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Bj4zgFgh.js";import"./createLucideIcon-CcZox8w1.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
