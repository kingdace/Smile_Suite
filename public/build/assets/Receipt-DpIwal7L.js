import{j as t,$ as f,m as u}from"./app-BCvq4mhZ.js";import{B as s}from"./button-CGjX2Iha.js";import{A as j}from"./arrow-left-DtYCuVVa.js";import{D as w}from"./download-BfaRkgP4.js";import{P as N}from"./printer-C-ZsBsl1.js";import{S as v,P as k}from"./scissors-C-x-d2pt.js";import{S as P}from"./stethoscope-BptKw3jU.js";import{D}from"./dollar-sign-CGDlbN_J.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BCfhcuWy.js";import"./createLucideIcon-CK2andJk.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
