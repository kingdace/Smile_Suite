import{j as t,$ as f,m as u}from"./app-C_vSCROP.js";import{B as s}from"./button-Ca6q9jOO.js";import{A as j}from"./arrow-left-DCoks0eM.js";import{D as w}from"./download-DBuAVjej.js";import{P as N}from"./printer-CIgT-0Ha.js";import{S as v,P as k}from"./scissors-BaxixffR.js";import{S as P}from"./stethoscope-1qI4dtcE.js";import{D}from"./dollar-sign-E2-kA2Hd.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BEHfmKsg.js";import"./createLucideIcon-Cb4BwkIi.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
