import{j as t,$ as f,m as u}from"./app-eK6w5SaP.js";import{B as s}from"./button-DPr21cI2.js";import{A as j}from"./arrow-left-BFwdlvX7.js";import{D as w}from"./download-DsdHQskX.js";import{P as N}from"./printer-DagdE5Lf.js";import{S as v,P as k}from"./scissors-B3EXdJKA.js";import{S as P}from"./stethoscope-CkAQuCDU.js";import{D}from"./dollar-sign-C9c0wRfb.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BRP8Uz7d.js";import"./createLucideIcon-Bpgq9mee.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
