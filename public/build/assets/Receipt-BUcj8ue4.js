import{j as t,$ as f,m as u}from"./app-X78Y7oGJ.js";import{B as s}from"./button-B9ioxVR3.js";import{A as j}from"./arrow-left-BFD08Ymk.js";import{D as w}from"./download-DSMlwvU2.js";import{P as N}from"./printer-BCNyUXgh.js";import{S as v,P as k}from"./scissors-D2tEPVVN.js";import{S as P}from"./stethoscope-BP690pf8.js";import{D}from"./dollar-sign-B-OKVqG9.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-D1zgcD9o.js";import"./createLucideIcon-eLeEsc_2.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
