import{j as t,$ as f,m as u}from"./app-ZxAlEvdA.js";import{B as s}from"./button-Cdvy3pKR.js";import{A as j}from"./arrow-left-B0IiDAMV.js";import{D as w}from"./download-DIT3-u_V.js";import{P as N}from"./printer-4oehM9zs.js";import{S as v,P as k}from"./scissors-C-Mp-MSs.js";import{S as P}from"./stethoscope-CTZofBPm.js";import{D}from"./dollar-sign-Dwk-W496.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-IHKkMNBC.js";import"./createLucideIcon-yAbt-hik.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
