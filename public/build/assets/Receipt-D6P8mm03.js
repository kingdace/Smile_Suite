import{j as t,$ as f,m as u}from"./app-0NEBy9BJ.js";import{B as s}from"./button-HTjkDkdd.js";import{A as j}from"./arrow-left-D43ESfQ7.js";import{D as w}from"./download-DvekdBIG.js";import{P as N}from"./printer-D2fGbm_3.js";import{S as v,P as k}from"./scissors-DUdWMhH-.js";import{S as P}from"./stethoscope-DQNiqfGN.js";import{D}from"./dollar-sign-DyPiHvO_.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-D_vL4xTc.js";import"./createLucideIcon-CXdhGpw2.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
