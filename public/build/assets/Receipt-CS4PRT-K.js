import{j as t,$ as f,m as u}from"./app-ADK_JQaa.js";import{B as s}from"./button-DVWnkNmK.js";import{A as j}from"./arrow-left-vaBAUfs4.js";import{D as w}from"./download-t61E71JZ.js";import{P as N}from"./printer-BMvxyHq5.js";import{S as v,P as k}from"./scissors-D0oLCQ5R.js";import{S as P}from"./stethoscope-HYB98YPc.js";import{D}from"./dollar-sign-Dxcencbn.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DNmM3B-y.js";import"./createLucideIcon-B9Yh0vZ4.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
