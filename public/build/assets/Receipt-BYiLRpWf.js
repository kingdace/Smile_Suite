import{j as t,$ as f,m as u}from"./app-BE7syB-l.js";import{B as s}from"./button-DcJ55ncs.js";import{A as j}from"./arrow-left-CjxvTAQS.js";import{D as w}from"./download-TQrMs90m.js";import{P as N}from"./printer-_yw7vWeF.js";import{S as v,P as k}from"./scissors-Cj8zF-Y2.js";import{S as P}from"./stethoscope-A1gX5KEf.js";import{D}from"./dollar-sign-BNIlovVe.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-dny2Nr_O.js";import"./createLucideIcon-CVD7KIZ1.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
