import{j as t,$ as f,m as u}from"./app-DzAKanfO.js";import{B as s}from"./button-BaVC9LH_.js";import{A as j}from"./arrow-left-CPCCsctB.js";import{D as w}from"./download-DdB1cSsm.js";import{P as N}from"./printer-DFF8baFo.js";import{S as v,P as k}from"./scissors-5AZmbKVD.js";import{S as P}from"./stethoscope-CYcZ01Kt.js";import{D}from"./dollar-sign-BK8VwfMG.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CpWIITha.js";import"./createLucideIcon-DZDivllp.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
