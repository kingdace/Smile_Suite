import{j as t,$ as f,m as u}from"./app-B9_Xbdlr.js";import{B as s}from"./button-DJCJ9FQq.js";import{A as j}from"./arrow-left-QzgEyofK.js";import{D as w}from"./download-DLRvYTu4.js";import{P as N}from"./printer-CVBKJeqn.js";import{S as v,P as k}from"./scissors-BsM0aRZB.js";import{S as P}from"./stethoscope-gznN5WJZ.js";import{D}from"./dollar-sign-DbCJ8n-h.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BJomnJ_d.js";import"./createLucideIcon-DlcZbYnM.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
