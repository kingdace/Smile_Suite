import{j as t,$ as f,m as u}from"./app--gjHUBWu.js";import{B as s}from"./button-DxGj5stL.js";import{A as j}from"./arrow-left-wWDVRtSg.js";import{D as w}from"./download-CIs6Flw8.js";import{P as N}from"./printer-QbTzVn1u.js";import{S as v,P as k}from"./scissors-CFcgAZ1G.js";import{S as P}from"./stethoscope-Bk0jiV-r.js";import{D}from"./dollar-sign-j-R5c25v.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-B2zhedAb.js";import"./createLucideIcon-DvDOFTDZ.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
