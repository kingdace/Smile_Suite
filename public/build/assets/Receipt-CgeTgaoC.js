import{j as t,$ as f,m as u}from"./app-C8kdbIfg.js";import{B as s}from"./button-CtBDG8qG.js";import{A as j}from"./arrow-left-BD4LdG_T.js";import{D as w}from"./download-Blox7fCr.js";import{P as N}from"./printer-BjIXPErQ.js";import{S as v,P as k}from"./scissors-CttdPSXS.js";import{S as P}from"./stethoscope-C-0Z68Vf.js";import{D}from"./dollar-sign-CFER_2Rp.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Cs505U2P.js";import"./createLucideIcon-DmdO-xBx.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
