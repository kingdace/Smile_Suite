import{j as t,$ as f,m as u}from"./app-CRQnRi-5.js";import{B as s}from"./button-Co-Z4Jj4.js";import{A as j}from"./arrow-left-4uMB65ya.js";import{D as w}from"./download-qmynojiv.js";import{P as N}from"./printer-Vuhk2k6O.js";import{S as v,P as k}from"./scissors-CGBV4iaa.js";import{S as P}from"./stethoscope-BPLge9bk.js";import{D}from"./dollar-sign-DJK9zm6D.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Ds0G9NPp.js";import"./createLucideIcon-D-9FcAzN.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
