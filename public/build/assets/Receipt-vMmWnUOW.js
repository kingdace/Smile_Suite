import{j as t,$ as f,m as u}from"./app-5a0_h0Kq.js";import{B as s}from"./button-1GgLCHzH.js";import{A as j}from"./arrow-left-C3ZT1XfF.js";import{D as w}from"./download-DrfedBNM.js";import{P as N}from"./printer-bvHi_GRS.js";import{S as v,P as k}from"./scissors-Dd42I0pG.js";import{S as P}from"./stethoscope-DgNRDGZ0.js";import{D}from"./dollar-sign-BOVy0yIQ.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-AFN33q32.js";import"./createLucideIcon-BJZvTZLF.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
