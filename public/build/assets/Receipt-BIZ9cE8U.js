import{j as t,$ as f,m as u}from"./app-CGQLvX26.js";import{B as s}from"./button-BgeaJoce.js";import{A as j}from"./arrow-left-Bu-mx3h_.js";import{D as w}from"./download-CKpSBbK_.js";import{P as N}from"./printer-C9_wYJlC.js";import{S as v,P as k}from"./scissors-DM0V1D5G.js";import{S as P}from"./stethoscope-BEzXu6Md.js";import{D}from"./dollar-sign-Cad2hBWQ.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BOca-V3F.js";import"./createLucideIcon-DHTXbD_m.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
