import{j as t,$ as f,m as u}from"./app-BWxQYrX6.js";import{B as s}from"./button-CPcSBPFh.js";import{A as j}from"./arrow-left-BNGReqYb.js";import{D as w}from"./download-B-YuxVwQ.js";import{P as N}from"./printer-DMks0lQj.js";import{S as v,P as k}from"./scissors-Dqps4-NJ.js";import{S as P}from"./stethoscope-BePhj6bx.js";import{D}from"./dollar-sign-JaFWOl8x.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BGZbWSET.js";import"./createLucideIcon-C-SF-e7E.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
