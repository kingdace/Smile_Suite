import{j as t,$ as f,m as u}from"./app-7a2xc5x7.js";import{B as s}from"./button-Snt9n3fk.js";import{A as j}from"./arrow-left-CuP-Cw07.js";import{D as w}from"./download-BXb_k23L.js";import{P as N}from"./printer-DgNLOThe.js";import{S as v,P as k}from"./scissors-zmNI1ReT.js";import{S as P}from"./stethoscope-CbZhDxGP.js";import{D}from"./dollar-sign-CtW4mPxj.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-C0XUc4Mh.js";import"./createLucideIcon-DO3_KBZL.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
