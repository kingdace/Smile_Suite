import{j as t,$ as f,m as u}from"./app-B4W2uAQx.js";import{B as s}from"./button-agFj_53e.js";import{A as j}from"./arrow-left-BdJsQ6UI.js";import{D as w}from"./download-Bv6CaL6Q.js";import{P as N}from"./printer-CW_FexPb.js";import{S as v,P as k}from"./scissors-BPY13bsi.js";import{S as P}from"./stethoscope-B-AI__qP.js";import{D}from"./dollar-sign-TPegZHBH.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Ce7U8e2h.js";import"./createLucideIcon-CpXs6mo-.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
