import{j as t,$ as f,m as u}from"./app-B4xVbahq.js";import{B as s}from"./button-BDQzR54m.js";import{A as j}from"./arrow-left-Du2RkIOs.js";import{D as w}from"./download-CcOqVkmC.js";import{P as N}from"./printer-BtIO4_gY.js";import{S as v,P as k}from"./scissors-51VX-fD8.js";import{S as P}from"./stethoscope-DVO7bAga.js";import{D}from"./dollar-sign-DzOjImuL.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-D9C4qfJ1.js";import"./createLucideIcon-FSYzCwnz.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
