import{j as t,$ as f,m as u}from"./app-DSOMZZ04.js";import{B as s}from"./button-C3XcdNkD.js";import{A as j}from"./arrow-left-CuMLa5XX.js";import{D as w}from"./download-cwiXWOPt.js";import{P as N}from"./printer-SNR2D-5F.js";import{S as v,P as k}from"./scissors-CK5HAn94.js";import{S as P}from"./stethoscope-B7DRS_lf.js";import{D}from"./dollar-sign-Bo7kSdLd.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CPf3WCTV.js";import"./createLucideIcon-B1fRB1wE.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
