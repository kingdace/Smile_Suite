import{j as t,$ as f,m as u}from"./app-DbZf-9u-.js";import{B as s}from"./button-BJUl4hKH.js";import{A as j}from"./arrow-left-BQk0TR9n.js";import{D as w}from"./download-zzkRCJ0T.js";import{P as N}from"./printer-21Z8QjWR.js";import{S as v,P as k}from"./scissors-BJHuHQ_w.js";import{S as P}from"./stethoscope-BlTh8ubU.js";import{D}from"./dollar-sign-DgwNyY8u.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BErJrXxA.js";import"./createLucideIcon-CpdpnsRp.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
