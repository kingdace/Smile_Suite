import{j as t,$ as f,m as u}from"./app-CUCSecjn.js";import{B as s}from"./button-BF7VGH8l.js";import{A as j}from"./arrow-left-BqfuNkPk.js";import{D as w}from"./download-CsO7AhrA.js";import{P as N}from"./printer-Cuxul_t5.js";import{S as v,P as k}from"./scissors-Dt0bro7U.js";import{S as P}from"./stethoscope-D7GVvBn_.js";import{D}from"./dollar-sign-VTX7N1Wn.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DOHtvV1D.js";import"./createLucideIcon-DiOBzUyV.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
