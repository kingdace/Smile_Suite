import{j as t,$ as f,m as u}from"./app-DYbainwe.js";import{B as s}from"./button-DgM1p2pj.js";import{A as j}from"./arrow-left-B5lLTyoi.js";import{D as w}from"./download-DIhZoLXZ.js";import{P as N}from"./printer-CNunPfgj.js";import{S as v,P as k}from"./scissors-NlPQzKy-.js";import{S as P}from"./stethoscope-4HnScyeR.js";import{D}from"./dollar-sign-BGLRIgz4.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BE6a3qcx.js";import"./createLucideIcon-vOnoAryn.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
