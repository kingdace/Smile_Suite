import{j as t,$ as f,m as u}from"./app-CNfyEHHb.js";import{B as s}from"./button-CpDM02aR.js";import{A as j}from"./arrow-left-BOwXCLUb.js";import{D as w}from"./download-KtFh6I0B.js";import{P as N}from"./printer-D86UAj38.js";import{S as v,P as k}from"./scissors-Cn6Gopv5.js";import{S as P}from"./stethoscope-BNkuKhb-.js";import{D}from"./dollar-sign-DQwnCllT.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Cq_s61tz.js";import"./createLucideIcon-CI-tbqHn.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
