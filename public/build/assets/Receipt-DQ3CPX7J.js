import{j as t,$ as f,m as u}from"./app-BScAtUKl.js";import{B as s}from"./button-Be3JExiR.js";import{A as j}from"./arrow-left-DdUiPjWf.js";import{D as w}from"./download-D_eCsKTr.js";import{P as N}from"./printer-CoYpyot_.js";import{S as v,P as k}from"./scissors-C1ppGS-w.js";import{S as P}from"./stethoscope-CAN4f2Ow.js";import{D}from"./dollar-sign-CTbUGJnZ.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BF8zTHCP.js";import"./createLucideIcon-DvHACIcq.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
