import{j as t,$ as f,m as u}from"./app-BpQkB6JY.js";import{B as s}from"./button-uttbRvsG.js";import{A as j}from"./arrow-left-C8FNbu8s.js";import{D as w}from"./download-DE7OGBhm.js";import{P as N}from"./printer-CSsRPUYi.js";import{S as v,P as k}from"./scissors-CctyRiYB.js";import{S as P}from"./stethoscope-BByYkrV9.js";import{D}from"./dollar-sign-BG6C9tCJ.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BfaTFcgm.js";import"./createLucideIcon-DUlXK5DT.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
