import{j as t,$ as f,m as u}from"./app-B7XmtxP3.js";import{B as s}from"./button-CkW2QNgG.js";import{A as j}from"./arrow-left-1YTAt68l.js";import{D as w}from"./download-bZYOImUG.js";import{P as N}from"./printer-DQHjlWKf.js";import{S as v,P as k}from"./scissors-5Qq5L5lu.js";import{S as P}from"./stethoscope-DSMbGlh7.js";import{D}from"./dollar-sign-BT1nc533.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DeXZtp3E.js";import"./createLucideIcon-DTMvjL9J.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
