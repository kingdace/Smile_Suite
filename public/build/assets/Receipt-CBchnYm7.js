import{j as t,$ as f,m as u}from"./app-CI1YU0bf.js";import{B as s}from"./button-IEhKNFy1.js";import{A as j}from"./arrow-left-C8W-HopQ.js";import{D as w}from"./download-DdKxr-F9.js";import{P as N}from"./printer-D0wG5BBH.js";import{S as v,P as k}from"./scissors-qD3g5fzQ.js";import{S as P}from"./stethoscope-CwHFKCfc.js";import{D}from"./dollar-sign-DRvFHWWi.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-dBR_Utb4.js";import"./createLucideIcon-DAru_sdr.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
