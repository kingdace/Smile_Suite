import{j as t,$ as f,m as u}from"./app-DT2kOcIG.js";import{B as s}from"./button-B5iqFv_c.js";import{A as j}from"./arrow-left-DsmN7ONo.js";import{D as w}from"./download-BWErM53d.js";import{P as N}from"./printer-BqRg4m2E.js";import{S as v,P as k}from"./scissors-BY0IPAAw.js";import{S as P}from"./stethoscope-Bx6Qdso0.js";import{D}from"./dollar-sign-BPo2vAEL.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CGIN75iC.js";import"./createLucideIcon-BJOiZROO.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
