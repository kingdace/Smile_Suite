import{j as t,$ as f,m as u}from"./app-DzZwPyuv.js";import{B as s}from"./button-OhLaAZQ6.js";import{A as j}from"./arrow-left-Db0HBMkO.js";import{D as w}from"./download-B0c7efd-.js";import{P as N}from"./printer-CJaiPxSW.js";import{S as v,P as k}from"./scissors--KN4crz5.js";import{S as P}from"./stethoscope-D3wWLYjf.js";import{D}from"./dollar-sign-D3GbvMlZ.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-H8u0a_9H.js";import"./createLucideIcon-Dlae6tC5.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
