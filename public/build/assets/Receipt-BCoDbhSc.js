import{j as t,$ as f,m as u}from"./app-DisvMH-G.js";import{B as s}from"./button-Dc8x0FhQ.js";import{A as j}from"./arrow-left-DwumRTtA.js";import{D as w}from"./download-Auq5XXkX.js";import{P as N}from"./printer-Cqc928hr.js";import{S as v,P as k}from"./scissors-C3A8O9sq.js";import{S as P}from"./stethoscope-BLcoKnko.js";import{D}from"./dollar-sign-BtCjXW61.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Drm7t3pq.js";import"./createLucideIcon-B6b_02KL.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
