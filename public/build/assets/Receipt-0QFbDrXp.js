import{j as t,$ as f,m as u}from"./app-BZImrTI7.js";import{B as s}from"./button-4T1nFGI6.js";import{A as j}from"./arrow-left-BvqeXZyW.js";import{D as w}from"./download-BBK0BScz.js";import{P as N}from"./printer-BueSofm6.js";import{S as v,P as k}from"./scissors-C0mPH80j.js";import{S as P}from"./stethoscope-BoSLVVsf.js";import{D}from"./dollar-sign-npA69rse.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-D629ERIh.js";import"./createLucideIcon-B5kt4gU1.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
