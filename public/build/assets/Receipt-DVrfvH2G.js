import{j as t,$ as f,m as u}from"./app-C4TBilXs.js";import{B as s}from"./button-LvBQWQ0X.js";import{A as j}from"./arrow-left-BV9Mn_9T.js";import{D as w}from"./download-QLjqFqPT.js";import{P as N}from"./printer-BmcjI_f2.js";import{S as v,P as k}from"./scissors-De3IvsBL.js";import{S as P}from"./stethoscope-DT7m4-QQ.js";import{D}from"./dollar-sign-BZJe9CW2.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-dJJqFgFH.js";import"./createLucideIcon-BWebMw4r.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
