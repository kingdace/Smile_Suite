import{j as t,$ as f,m as u}from"./app-ChT4py85.js";import{B as s}from"./button-CGoxA_N6.js";import{A as j}from"./arrow-left-MCOObQde.js";import{D as w}from"./download-6zttKGDB.js";import{P as N}from"./printer-CCH8XFDU.js";import{S as v,P as k}from"./scissors-DDOyghhR.js";import{S as P}from"./stethoscope-CQo_euT6.js";import{D}from"./dollar-sign-BxaCgN3V.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-C6091ngi.js";import"./createLucideIcon-C_Uc9QC0.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
