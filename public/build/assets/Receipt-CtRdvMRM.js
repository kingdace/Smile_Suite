import{j as t,$ as f,m as u}from"./app-BHuvsnNX.js";import{B as s}from"./button-jnaGu_dU.js";import{A as j}from"./arrow-left-lGbdgPmC.js";import{D as w}from"./download-Cngadinq.js";import{P as N}from"./printer-DwQeVHVZ.js";import{S as v,P as k}from"./scissors-9s4Ck65d.js";import{S as P}from"./stethoscope-Bf_du_hY.js";import{D}from"./dollar-sign-CXrSpInT.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CueV_d4B.js";import"./createLucideIcon-DCkzHz-q.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
