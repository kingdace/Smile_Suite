import{j as t,$ as f,m as u}from"./app-CWw5YhVw.js";import{B as s}from"./button-BqFuxQiO.js";import{A as j}from"./arrow-left-1W0bNQn1.js";import{D as w}from"./download-CivGW3aT.js";import{P as N}from"./printer-COeTqizP.js";import{S as v,P as k}from"./scissors-C3P_YGKn.js";import{S as P}from"./stethoscope-C31BCKar.js";import{D}from"./dollar-sign-BsUUHUWU.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-B1CVrzrI.js";import"./createLucideIcon-ClkGE_pq.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
