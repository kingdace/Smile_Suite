import{j as t,$ as f,m as u}from"./app-B8C0NUAR.js";import{B as s}from"./button-DGTugbgC.js";import{A as j}from"./arrow-left-C3tMSC9z.js";import{D as w}from"./download-CyW-VVU_.js";import{P as N}from"./printer-C99fGQl-.js";import{S as v,P as k}from"./scissors-Bj05etWL.js";import{S as P}from"./stethoscope-DYNMFZp8.js";import{D}from"./dollar-sign-CzopBCEE.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BxpSC0Cy.js";import"./createLucideIcon-B5RLc5aM.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
