import{j as t,$ as f,m as u}from"./app-DOv5ON3D.js";import{B as s}from"./button-ChGzY_6t.js";import{A as j}from"./arrow-left-BKHZX_Ux.js";import{D as w}from"./download-CyqPxUHV.js";import{P as N}from"./printer-DH4c8Yxr.js";import{S as v,P as k}from"./scissors-BQzAfywN.js";import{S as P}from"./stethoscope-D07fpGUN.js";import{D}from"./dollar-sign-DzSgJtzs.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Chwef4-S.js";import"./createLucideIcon-CcwbVh97.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
