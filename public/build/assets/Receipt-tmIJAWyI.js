import{j as t,$ as f,m as u}from"./app-JoLosXoW.js";import{B as s}from"./button-B1JZQc7h.js";import{A as j}from"./arrow-left-CyCdm87S.js";import{D as w}from"./download-Bs-ftrxW.js";import{P as N}from"./printer-nNEfGLlq.js";import{S as v,P as k}from"./scissors-D5lIadCj.js";import{S as P}from"./stethoscope-C5vdc3ma.js";import{D}from"./dollar-sign-Bsyz05Jp.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DL7M62fD.js";import"./createLucideIcon-CoLwg_J1.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
