import{j as t,$ as f,m as u}from"./app-DEYh6a4w.js";import{B as s}from"./button-q8ihA1TE.js";import{A as j}from"./arrow-left-6NORUFNI.js";import{D as w}from"./download-CaRHQxrT.js";import{P as N}from"./printer-B1SA1bLG.js";import{S as v,P as k}from"./scissors-i0Uhc0qk.js";import{S as P}from"./stethoscope-RKBr9P89.js";import{D}from"./dollar-sign-DWxeUz6K.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-D1jFUERj.js";import"./createLucideIcon-CXz3HXcN.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
