import{j as t,$ as f,m as u}from"./app-DWtaGTnW.js";import{B as s}from"./button-BS7p0gGY.js";import{A as j}from"./arrow-left-CA8SY6zB.js";import{D as w}from"./download-CQINv2Z_.js";import{P as N}from"./printer-C65TTcFd.js";import{S as v,P as k}from"./scissors-BK5ojHVL.js";import{S as P}from"./stethoscope-D7ne-SBs.js";import{D}from"./dollar-sign-C0O7OlyD.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-sPLcCCKX.js";import"./createLucideIcon-P_fQZioE.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
