import{j as t,$ as f,m as u}from"./app-CnPAsyY7.js";import{B as s}from"./button-CKfO3Cdr.js";import{A as j}from"./arrow-left-aQAZsFHx.js";import{D as w}from"./download-M9V8qMQM.js";import{P as N}from"./printer-BRwl6BTF.js";import{S as v,P as k}from"./scissors-D1P8w50S.js";import{S as P}from"./stethoscope-WEg-5Jhk.js";import{D}from"./dollar-sign-B-2JeW03.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CqPhuiSr.js";import"./createLucideIcon-NZsTavVm.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
