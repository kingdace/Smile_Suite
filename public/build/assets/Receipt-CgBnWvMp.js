import{j as t,$ as f,m as u}from"./app-D6t2smyk.js";import{B as s}from"./button-dPFBQpbM.js";import{A as j}from"./arrow-left-ATUYjrnD.js";import{D as w}from"./download-Dyevrpx9.js";import{P as N}from"./printer-pOPFU1uI.js";import{S as v,P as k}from"./scissors-DuPGUEay.js";import{S as P}from"./stethoscope-CiMDiDyG.js";import{D}from"./dollar-sign-OnR15fna.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DSpYuKd7.js";import"./createLucideIcon-LzGYOMAW.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
