import{j as t,$ as f,m as u}from"./app-CmV2pMm0.js";import{B as s}from"./button-nOd1FdfU.js";import{A as j}from"./arrow-left-Dc-zuVl3.js";import{D as w}from"./download-Bq_vbLxg.js";import{P as N}from"./printer-BdzeIBbV.js";import{S as v,P as k}from"./scissors-CdUYWw2N.js";import{S as P}from"./stethoscope-euRVD378.js";import{D}from"./dollar-sign-BPVpZbar.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-7UsQU1YD.js";import"./createLucideIcon-D7wapDZ_.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
