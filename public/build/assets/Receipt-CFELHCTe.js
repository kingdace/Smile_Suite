import{j as t,$ as f,m as u}from"./app-B-Ino5z-.js";import{B as s}from"./button-DOzAWbjB.js";import{A as j}from"./arrow-left-CwOyJZnH.js";import{D as w}from"./download-BGq_j14M.js";import{P as N}from"./printer-CICMxb0T.js";import{S as v,P as k}from"./scissors-DsqQVQcP.js";import{S as P}from"./stethoscope-uFC1-q4L.js";import{D}from"./dollar-sign-Ce1VqIOi.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CSlS9bWT.js";import"./createLucideIcon-B_vFgfHh.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
