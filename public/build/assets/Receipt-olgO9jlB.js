import{j as t,$ as f,m as u}from"./app-ZHYUWYtI.js";import{B as s}from"./button-CdiDQIEp.js";import{A as j}from"./arrow-left-DaPp_DIX.js";import{D as w}from"./download-DUBTvXxh.js";import{P as N}from"./printer-c_gLsYUY.js";import{S as v,P as k}from"./scissors-gWZDeBhH.js";import{S as P}from"./stethoscope-cIY2JHmw.js";import{D}from"./dollar-sign-ZsPWWUWj.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-zwo3oFhk.js";import"./createLucideIcon-DZiYLKOr.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
