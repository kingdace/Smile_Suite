import{j as t,$ as f,m as u}from"./app-DjHFrvhH.js";import{B as s}from"./button-D73TQO5b.js";import{A as j}from"./arrow-left-D-AuaUKD.js";import{D as w}from"./download-ChWYbamh.js";import{P as N}from"./printer-QDSGrDiW.js";import{S as v,P as k}from"./scissors-pwNGBZ2P.js";import{S as P}from"./stethoscope-ClhsvxPs.js";import{D}from"./dollar-sign-tBW-GaGx.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CYqYf19I.js";import"./createLucideIcon-_J1GjqMc.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
