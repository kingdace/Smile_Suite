import{j as t,$ as f,m as u}from"./app-DK0U98Wz.js";import{B as s}from"./button-CePfRH1f.js";import{A as j}from"./arrow-left-DEJZaSKC.js";import{D as w}from"./download-DcE1F1Uz.js";import{P as N}from"./printer-469X7A6l.js";import{S as v,P as k}from"./scissors-DhkhjU0K.js";import{S as P}from"./stethoscope-D0etxGLv.js";import{D}from"./dollar-sign-D1Gj4B16.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-06x71x9g.js";import"./createLucideIcon-CaRbllk6.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
