import{j as t,$ as f,m as u}from"./app-CO-a6OBO.js";import{B as s}from"./button-pGrNtzTa.js";import{A as j}from"./arrow-left-CLfOXDER.js";import{D as w}from"./download-BsoU1-S7.js";import{P as N}from"./printer-C-lDxJAE.js";import{S as v,P as k}from"./scissors-CDrVjBPu.js";import{S as P}from"./stethoscope-m-VFaTsa.js";import{D}from"./dollar-sign-jSQ-H98C.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-D390rYY4.js";import"./createLucideIcon-I6gKqtOe.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
