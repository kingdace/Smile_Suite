import{j as t,$ as f,m as u}from"./app-OYqhNv4S.js";import{B as s}from"./button-BqZFISJU.js";import{A as j}from"./arrow-left-59q-2iS_.js";import{D as w}from"./download-DwJZkr97.js";import{P as N}from"./printer-DXGvL5_1.js";import{S as v,P as k}from"./scissors-BbFjdrNM.js";import{S as P}from"./stethoscope-C0Giin7I.js";import{D}from"./dollar-sign-ePavS67L.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CDq1CAyD.js";import"./createLucideIcon-BEwYmTUl.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
