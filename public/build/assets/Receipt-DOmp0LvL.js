import{j as t,$ as f,m as u}from"./app-CXR0ywty.js";import{B as s}from"./button-gN2Sh24W.js";import{A as j}from"./arrow-left-BCFM89AX.js";import{D as w}from"./download-CBa75YJy.js";import{P as N}from"./printer-CfP31EvQ.js";import{S as v,P as k}from"./scissors-rHi7vpc7.js";import{S as P}from"./stethoscope-Bt_jh0N5.js";import{D}from"./dollar-sign-CA-TIMYI.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DAGSlW9S.js";import"./createLucideIcon-CnqQk6VY.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
