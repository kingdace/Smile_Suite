import{j as t,$ as f,m as u}from"./app-Dz72U3F5.js";import{B as s}from"./button-DrxyfbKU.js";import{A as j}from"./arrow-left-CrTUJDOV.js";import{D as w}from"./download-BgUcmp6Z.js";import{P as N}from"./printer-BFB4Bdv-.js";import{S as v,P as k}from"./scissors-D0UroWOD.js";import{S as P}from"./stethoscope-CmJFGa-m.js";import{D}from"./dollar-sign-Dct6HeY7.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Dxtoks8l.js";import"./createLucideIcon-DsfP6Fpg.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
