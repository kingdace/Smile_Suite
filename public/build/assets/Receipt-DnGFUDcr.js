import{j as t,$ as f,m as u}from"./app-BytpB0TX.js";import{B as s}from"./button-CtZjCLMA.js";import{A as j}from"./arrow-left-BHUmxfQt.js";import{D as w}from"./download-k8Hl5DUf.js";import{P as N}from"./printer-DvNODnr-.js";import{S as v,P as k}from"./scissors-C29IvCgD.js";import{S as P}from"./stethoscope-CCt4NXon.js";import{D}from"./dollar-sign-CmdQIFbL.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Bce1V77q.js";import"./createLucideIcon-C9b6KVSr.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
