import{j as t,$ as f,m as u}from"./app-bXxerv5j.js";import{B as s}from"./button-CA0HLn3E.js";import{A as j}from"./arrow-left-CVbiRSJP.js";import{D as w}from"./download-DMMXifF4.js";import{P as N}from"./printer-qEt9g3Jk.js";import{S as v,P as k}from"./scissors-Cl7C3g-3.js";import{S as P}from"./stethoscope-YCDyCHao.js";import{D}from"./dollar-sign-syke0NFv.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BGtYn49R.js";import"./createLucideIcon-DcemB_4J.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
