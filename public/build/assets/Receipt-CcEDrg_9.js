import{j as t,$ as f,m as u}from"./app-L2nn2xUC.js";import{B as s}from"./button-BdbZw_aN.js";import{A as j}from"./arrow-left-DPRdBCl-.js";import{D as w}from"./download-PrNaHxoh.js";import{P as N}from"./printer-BKtbyASO.js";import{S as v,P as k}from"./scissors-Di54v3bK.js";import{S as P}from"./stethoscope-lrj-c3yo.js";import{D}from"./dollar-sign-D_-wpccy.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-De9ZqIEj.js";import"./createLucideIcon-CCIed56o.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
