import{j as t,$ as f,m as u}from"./app-CPhqtEaT.js";import{B as s}from"./button-DrWlW1jZ.js";import{A as j}from"./arrow-left-CZmpo6ja.js";import{D as w}from"./download-DzXyG_Gi.js";import{P as N}from"./printer-DBy33Xrp.js";import{S as v,P as k}from"./scissors-BjP6nvzd.js";import{S as P}from"./stethoscope-EBEC0b2r.js";import{D}from"./dollar-sign-Ba5QxzVr.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-Dv6OFj0i.js";import"./createLucideIcon-CijJo2MV.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
