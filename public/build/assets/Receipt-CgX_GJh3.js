import{j as t,$ as f,m as u}from"./app-DjngEu8l.js";import{B as s}from"./button-BjSQFaVz.js";import{A as j}from"./arrow-left-DsWAbXV_.js";import{D as w}from"./download-B7htcgqR.js";import{P as N}from"./printer-BQey_-Su.js";import{S as v,P as k}from"./scissors-DWj-6a5p.js";import{S as P}from"./stethoscope-CNOJak_k.js";import{D}from"./dollar-sign-D1waFmvU.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BHqOW7k9.js";import"./createLucideIcon-_6BXdwJq.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
