import{j as t,$ as f,m as u}from"./app-BdTB5hWJ.js";import{B as s}from"./button-DGBFkpWT.js";import{A as j}from"./arrow-left-Cv5xUUSk.js";import{D as w}from"./download-CmjcA8wU.js";import{P as N}from"./printer-BepvwdXB.js";import{S as v,P as k}from"./scissors--JKLcjp-.js";import{S as P}from"./stethoscope-DCqyKlhG.js";import{D}from"./dollar-sign-9LMP-GZm.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DwE7GStO.js";import"./createLucideIcon-Ct9vqVJW.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
