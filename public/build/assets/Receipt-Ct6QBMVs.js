import{j as t,$ as f,m as u}from"./app-CWY3xJB-.js";import{B as s}from"./button-B3xEGyEO.js";import{A as j}from"./arrow-left-Bx4AcS2g.js";import{D as w}from"./download-BBwrXRRi.js";import{P as N}from"./printer-CvIPbFRm.js";import{S as v,P as k}from"./scissors-COFDoWHi.js";import{S as P}from"./stethoscope-rkb73OiC.js";import{D}from"./dollar-sign-Gg8ilvWp.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-C9J5oeKH.js";import"./createLucideIcon-CAlRxCbQ.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
