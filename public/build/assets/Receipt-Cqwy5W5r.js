import{j as t,$ as f,m as u}from"./app-Bl7SOdQY.js";import{B as s}from"./button-CHGzfqZA.js";import{A as j}from"./arrow-left-DlRnIhEQ.js";import{D as w}from"./download-DaYhS55q.js";import{P as N}from"./printer-DLUX4mv9.js";import{S as v,P as k}from"./scissors-CS2a6txM.js";import{S as P}from"./stethoscope-tNgPq_VY.js";import{D}from"./dollar-sign--_MdOEXA.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-C78iGvkg.js";import"./createLucideIcon-B1xeq3o_.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
