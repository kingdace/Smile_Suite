import{j as t,$ as f,m as u}from"./app-DPAwlzk8.js";import{B as s}from"./button-CzKfVYvD.js";import{A as j}from"./arrow-left-Bnzc_hSs.js";import{D as w}from"./download-B0DN11-1.js";import{P as N}from"./printer-CQzMAxOX.js";import{S as v,P as k}from"./scissors-qqE1EeXl.js";import{S as P}from"./stethoscope-DexW7WRG.js";import{D}from"./dollar-sign-CIPV-gNB.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-C7OYs8W8.js";import"./createLucideIcon-DtLzkUpw.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
