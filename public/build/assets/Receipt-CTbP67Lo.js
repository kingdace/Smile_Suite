import{j as t,$ as f,m as u}from"./app-Y1vYVEMq.js";import{B as s}from"./button-CFv7zcj1.js";import{A as j}from"./arrow-left-CyfcTMFG.js";import{D as w}from"./download-BEpT6AOP.js";import{P as N}from"./printer-BN4q--kd.js";import{S as v,P as k}from"./scissors-BC8xaArK.js";import{S as P}from"./stethoscope-BLiD5wsr.js";import{D}from"./dollar-sign-i6ldDeYD.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CsE93I9y.js";import"./createLucideIcon-DrJvZ8QX.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
