import{j as t,$ as f,m as u}from"./app-CxtFJaUe.js";import{B as s}from"./button-CSMbl9zs.js";import{A as j}from"./arrow-left-BS4ut7FA.js";import{D as w}from"./download-DE33wdMy.js";import{P as N}from"./printer-DLOeNBbj.js";import{S as v,P as k}from"./scissors-DBb0H-rS.js";import{S as P}from"./stethoscope-CiNIw5bt.js";import{D}from"./dollar-sign-DJXzAc-a.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BlTxD7KK.js";import"./createLucideIcon-DvehDUyx.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
