import{j as t,$ as f,m as u}from"./app-BDwVsqnw.js";import{B as s}from"./button-DzoJMY0U.js";import{A as j}from"./arrow-left-rcZcwJGn.js";import{D as w}from"./download-CYoK8yD-.js";import{P as N}from"./printer-C9-SpZLU.js";import{S as v,P as k}from"./scissors-DbDakRL-.js";import{S as P}from"./stethoscope-BAZKM5AS.js";import{D}from"./dollar-sign-CQRD0nVu.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DkG5i1V5.js";import"./createLucideIcon-DDtw_uoS.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
