import{j as t,$ as f,m as u}from"./app-Da6D7O2r.js";import{B as s}from"./button-3ZNbhmqQ.js";import{A as j}from"./arrow-left-BwR3Oa5F.js";import{D as w}from"./download-Bzwqxd8b.js";import{P as N}from"./printer-spTI4B31.js";import{S as v,P as k}from"./scissors-BBr5E2iH.js";import{S as P}from"./stethoscope-BItA7__8.js";import{D}from"./dollar-sign-0FagyLoH.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-CvaIq2t-.js";import"./createLucideIcon-DtwarINN.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
