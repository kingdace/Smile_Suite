import{j as t,$ as f,m as u}from"./app-C344CKnt.js";import{B as s}from"./button-l3kKPE0Q.js";import{A as j}from"./arrow-left-BZSBeXhO.js";import{D as w}from"./download-CAbc8zx6.js";import{P as N}from"./printer-BvoMdHa6.js";import{S as v,P as k}from"./scissors-mDxKr-Yr.js";import{S as P}from"./stethoscope-B8mEsaIW.js";import{D}from"./dollar-sign-DNKch3qE.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DYpkwn0X.js";import"./createLucideIcon-Dpr1PPW0.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
