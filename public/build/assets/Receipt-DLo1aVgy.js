import{j as t,$ as f,m as u}from"./app-helSaB0q.js";import{B as s}from"./button-OHqBt0Gq.js";import{A as j}from"./arrow-left-BirkeUmC.js";import{D as w}from"./download-DCrnrCTG.js";import{P as N}from"./printer-ITAinU4b.js";import{S as v,P as k}from"./scissors-CqpONCD5.js";import{S as P}from"./stethoscope-CqKgdp4p.js";import{D}from"./dollar-sign-Dzuo8wBb.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-bD7BvzXY.js";import"./createLucideIcon-TtT4PKUx.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
