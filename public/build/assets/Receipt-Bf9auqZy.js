import{j as t,$ as f,m as u}from"./app-DYm6eaFg.js";import{B as s}from"./button-Cofp3zbt.js";import{A as j}from"./arrow-left-BP640hfz.js";import{D as w}from"./download-Bmg5xz-C.js";import{P as N}from"./printer-DSZb19Q_.js";import{S as v,P as k}from"./scissors-gpaCAb0r.js";import{S as P}from"./stethoscope-DIKW84Ba.js";import{D}from"./dollar-sign-D8de4VeE.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-6ri1HP6k.js";import"./createLucideIcon-CV6-zBGv.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
