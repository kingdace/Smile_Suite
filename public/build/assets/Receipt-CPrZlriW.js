import{j as t,$ as f,m as u}from"./app-CrnLGyBi.js";import{B as s}from"./button-CzNUASQm.js";import{A as j}from"./arrow-left--ZLZGn_7.js";import{D as w}from"./download-BUWE4vCk.js";import{P as N}from"./printer-XyewUW1I.js";import{S as v,P as k}from"./scissors-C_V4la7U.js";import{S as P}from"./stethoscope-C6dVQuOC.js";import{D}from"./dollar-sign-8k9yguP6.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DbFk3UZL.js";import"./createLucideIcon-GudhbT6h.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
