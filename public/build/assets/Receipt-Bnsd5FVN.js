import{j as t,$ as f,m as u}from"./app-C5-ILrwK.js";import{B as s}from"./button-B39k-rM3.js";import{A as j}from"./arrow-left-CTWsQUqZ.js";import{D as w}from"./download-BDTjfsxb.js";import{P as N}from"./printer-CqJ3743E.js";import{S as v,P as k}from"./scissors-Cjs1yOxf.js";import{S as P}from"./stethoscope-gN0OoOoz.js";import{D}from"./dollar-sign-DjxXfhjA.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BjcfCblZ.js";import"./createLucideIcon-BCuaqAqB.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
