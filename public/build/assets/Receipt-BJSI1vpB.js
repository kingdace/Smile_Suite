import{j as t,$ as f,m as u}from"./app-DKSt0IHI.js";import{B as s}from"./button-YSxE95jR.js";import{A as j}from"./arrow-left-BnzC6lBV.js";import{D as w}from"./download-D5pcAfiT.js";import{P as N}from"./printer-b5sAkYZ-.js";import{S as v,P as k}from"./scissors-BIVDQj8r.js";import{S as P}from"./stethoscope-ByZ3vq8U.js";import{D}from"./dollar-sign-DGNeOzlh.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DWLnnkxO.js";import"./createLucideIcon-r_TfTAes.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
