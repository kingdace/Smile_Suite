import{j as t,$ as f,m as u}from"./app-39CltzEZ.js";import{B as s}from"./button-DZ_gML5Q.js";import{A as j}from"./arrow-left-D6PCTDta.js";import{D as w}from"./download-BdcXgxGw.js";import{P as N}from"./printer-Br7KP_56.js";import{S as v,P as k}from"./scissors-BOi86H-6.js";import{S as P}from"./stethoscope-D2JWLnHx.js";import{D}from"./dollar-sign-DQvL8DQu.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-_tIDeRDz.js";import"./createLucideIcon-xeUr5X85.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
