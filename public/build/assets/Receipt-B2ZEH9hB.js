import{j as t,$ as f,m as u}from"./app-BIQoLEN_.js";import{B as s}from"./button-uZu2ZyCY.js";import{A as j}from"./arrow-left-C35CW7Rj.js";import{D as w}from"./download-VbxhpxPA.js";import{P as N}from"./printer-C-znbA_c.js";import{S as v,P as k}from"./scissors-yIgU87FF.js";import{S as P}from"./stethoscope-D8vU0Tuo.js";import{D}from"./dollar-sign-tCjXBkII.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BmLNgXml.js";import"./createLucideIcon-D3UmdbQu.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
