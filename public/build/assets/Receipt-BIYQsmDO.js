import{j as t,$ as f,m as u}from"./app-BWAmq4dU.js";import{B as s}from"./button-bprhENgB.js";import{A as j}from"./arrow-left-CHs-GYIg.js";import{D as w}from"./download-6CAvgigH.js";import{P as N}from"./printer-DXHy3tiO.js";import{S as v,P as k}from"./scissors-02D_HgN5.js";import{S as P}from"./stethoscope-BKM1q0Ih.js";import{D}from"./dollar-sign-C2sDES8p.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-BAIQhrvr.js";import"./createLucideIcon-CNF_EARF.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
