import{j as t,$ as f,m as u}from"./app-Bl4nvIz4.js";import{B as s}from"./button-DQYhbdFh.js";import{A as j}from"./arrow-left-BLSgi1cR.js";import{D as w}from"./download-C7abJkbi.js";import{P as N}from"./printer-CjSkGahF.js";import{S as v,P as k}from"./scissors-BO-FuyYS.js";import{S as P}from"./stethoscope-DoMSJTZI.js";import{D}from"./dollar-sign-CegKXCzZ.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-C_FY_DoO.js";import"./createLucideIcon-C5vPpRGF.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
