import{j as t,$ as f,m as u}from"./app-DeEiYNi1.js";import{B as s}from"./button-BAQV7P6A.js";import{A as j}from"./arrow-left-C5ht-4dg.js";import{D as w}from"./download-BNYB-oQP.js";import{P as N}from"./printer-ClIjolEn.js";import{S as v,P as k}from"./scissors-BgdK1kx-.js";import{S as P}from"./stethoscope-B_IQS9pW.js";import{D}from"./dollar-sign-BKyO_SK4.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-DB3zb46i.js";import"./createLucideIcon-BpF3nEKH.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
