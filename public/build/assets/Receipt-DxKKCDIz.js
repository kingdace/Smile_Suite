import{j as t,$ as f,m as u}from"./app-7oM4gdkb.js";import{B as s}from"./button-B4h0wYq5.js";import{A as j}from"./arrow-left-C_RarBVX.js";import{D as w}from"./download-DE1aYZM8.js";import{P as N}from"./printer-mrz9aQrS.js";import{S as v,P as k}from"./scissors-LoupPkv9.js";import{S as P}from"./stethoscope-BFiK6-CB.js";import{D}from"./dollar-sign-BNloPT4h.js";import{f as d}from"./format-CYZdy3_o.js";import"./index-12AcG4rD.js";import"./createLucideIcon-BKfMZMif.js";function H({clinic:n,payment:e}){const a=r=>new Intl.NumberFormat("en-US",{style:"currency",currency:"PHP"}).format(r),l=r=>d(new Date(r),"MMM dd, yyyy"),c=r=>d(new Date(r),"MMM dd, yyyy 'at' h:mm a"),x=r=>r.replace("_"," ").replace(/\b\w/g,i=>i.toUpperCase()),h=()=>{window.print()},g=()=>{const r=window.open("","_blank"),i=document.querySelector(".receipt-container").innerHTML;r.document.write(`
            <!DOCTYPE html>
            <html>
            <head>
