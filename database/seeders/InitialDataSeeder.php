...
class InitialDataSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        if (!DB::table('clinics')->where('email', 'contact@enhaynesdental.com')->exists()) {
        ...
        if (!DB::table('users')->where('email', 'staff@staff.com')->exists()) {
            DB::table('users')->insert([
                'name' => 'Demo Staff',
        ...
        // Create a sample dentist if it doesn't exist
        if (!DB::table('users')->where('email', 'dentist@dentist.com')->exists()) {
            DB::table('users')->insert([
                'name' => 'Dr. John Doe',
        ...
        if (!DB::table('suppliers')->where('email', 'contact@dentalsupplies.com')->exists()) {
            $suppliers = [
                [
        ...
        // Create some sample inventory items if they don't exist
        if (!DB::table('inventory')->where('name', 'Dental Floss')->exists()) {
            $inventoryItems = [
                [
                    'name' => 'Dental Floss',
