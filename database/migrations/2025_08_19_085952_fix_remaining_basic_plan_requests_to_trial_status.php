...
return new class extends Migration
{
    ...
    {
        // Update remaining Basic plan requests that are approved or completed but still have 'pending' payment status
        ...
        Log::info("Fixed {$updatedCount} remaining Basic plan requests from 'pending' to 'trial' payment status");
    }
